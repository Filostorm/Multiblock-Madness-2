onEvent('ponder.registry', (event) => {
    event
        ...
        .scene('heph_forge', 'Building the Hephaestus Forge', 'kubejs:hephforge', (scene, util) => {
            ...
            scene
                .text(20, 'Place down a Smithing Table in the center', [4.5, 2, 4.5])
                .placeNearTarget();
            scene.idle(30);
        ...
        .scene('heph_forge2', 'Using the Hephaestus Forge', 'kubejs:hephforge', (scene, util) => {
            ...
            scene.text(
                60,
                'Darkstone Pedestals can be placed like so, they hold items for the ritual',
                [2.5, 1, 6.5]
            );
            let positions = [
                { x: 2, y: 1, z: 6 },
            ...
            scene.text(
                60,
                'Arcane Crystal Obelisks can be placed in the same spaces and passively generate Aureal',
                [2.5, 1, 6.5]
            );
