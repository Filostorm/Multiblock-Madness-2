...
onEvent('recipes', (event) => {
    ...
    event
        .custom({
            ...
            pattern: ['AABCD', 'AEFGC', 'BHHHB', 'GIFEA', 'JGBAA'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['ABCDD', 'BEFGD', 'CHHHC', 'DGFIJ', 'DDCJK'],
            key: {
                A: {
    ...
    //Blank Request Chip
    event
        .shaped('kubejs:empty_request_chip', ['ABA', 'CDC', 'EFE'], {
    ...
    //Refined Data
    event.recipes.multiblocked
        .multiblock('super_computational_matrix')
    ...
    event.recipes.multiblocked
        .multiblock('data_processing_unit')
    ...
    //Blueprint Recycling
    event.recipes
        .mekanismCrushing('30x kubejs:blueprint_fragment', 'kubejs:ripped_blueprint')
        .id(`mbm2:mekanism/crushing/blueprint_fragment`);
    event.recipes
        .immersiveengineeringCrusher('25x kubejs:blueprint_fragment', 'kubejs:ripped_blueprint')
        .id(`mbm2:immersiveengineering/crushing/blueprint_fragment`);
    ...
    asteroidComponents.forEach((asteroid) => {
        ...
        event.recipes.thermal
            .centrifuge(
                [
                    Item.of(`#forge:dusts/${asteroid.dust[0]}`).withChance(0.5),
                    Item.of(`#forge:dusts/${asteroid.dust[1]}`).withChance(0.3),
                    Item.of(`#forge:dusts/${asteroid.dust[2]}`).withChance(0.2),
                    Fluid.of(asteroid.fluid, 250)
                ],
                `kubejs:asteroid_dust_tier_${asteroid.tier}`
            )
            .id(`mbm2:centrifuge/asteroid_tier_${asteroid.tier}_dust`);
    });
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['  ABA  ', 'CDDEDDC', 'DDFGFDD', 'AHIJIHA', 'DDKLKDD', ' DMMMD ', '  N N  '],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['   A   ', '  BCB  ', ' BDEDB ', ' BFGFB ', ' BHIHB ', ' JJJJJ ', '  K K  '],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['   A   ', '  BBB  ', '  BCB  ', ' DBEBD ', 'DFDGDFD', 'DHD DHD', ' I   I '],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['   A   ', '  BCB  ', ' BBDBB ', 'EBFGFBE', 'EHIJIHE', ' HEKEH ', '   B   '],
            key: {
                A: {
                    item: 'kubejs:space_alloy_rocket_nose_cone'
                },
