onEvent('recipes', (event) => {
    ...
    event
        .custom({
            ...
            pattern: ['ABCBA', 'ADDDA', 'AEFEA', 'ADDDA', 'ABCBA'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['AABAA', 'ACBCA', 'BBDBB', 'ACBCA', 'AABAA'],
            key: {
                A: {
                    item: 'solarflux:photovoltaic_cell_6'
                },
    ...
    //Chip Combnonation 8
    event
        .shaped('kubejs:solar_chip_red', ['AAA', 'A A', 'AAA'], {
    ...
    event
        .shaped('kubejs:solar_chip_green', ['AAA', 'A A', 'AAA'], {
    ...
    event
        .shaped('kubejs:solar_chip_purple', ['AAA', 'A A', 'AAA'], {
    ...
    event.recipes
        .createCrushing(
            ...
            'kubejs:hostile_ai_chip'
        )
        .id(`mbm2:crushing/hostile_ai_chip`);
});
