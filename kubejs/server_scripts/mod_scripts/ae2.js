...
onEvent('recipes', (event) => {
    ...
    event
        .shaped('ae2:sky_stone_tank', ['AAA', 'ABA', 'AAA'], {
    ...
    global.powahEnergizing(
        event,
        [Item.of('ae2:certus_quartz_crystal').toJson()],
        Item.of('ae2:charged_certus_quartz_crystal'),
        25000,
        'mbm2:powah/charged_quartz'
    );
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createPressing('kubejs:incomplete_printed_silicon', [
                ...
                event.recipes
                    .createCutting('kubejs:incomplete_printed_silicon', [
                        'kubejs:incomplete_printed_silicon'
                    ])
                    .processingTime(100)
            ]
        )
        .transitionalItem('kubejs:incomplete_printed_silicon')
        .loops(1)
        .id(`mbm2:printed_silicon`);
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createPressing('kubejs:incomplete_printed_calculation_processor', [
                    'kubejs:incomplete_printed_calculation_processor'
                ]),
                event.recipes
                    .createCutting('kubejs:incomplete_printed_calculation_processor', [
                        'kubejs:incomplete_printed_calculation_processor'
                    ])
                    .processingTime(100),
                event.recipes.createPressing('kubejs:incomplete_printed_calculation_processor', [
        ...
        .transitionalItem('kubejs:incomplete_printed_calculation_processor')
        .loops(1)
        .id(`mbm2:printed_calculation_processor`);
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createDeploying('kubejs:incomplete_calculation_processor', [
                    'kubejs:incomplete_calculation_processor',
                    'ae2:printed_silicon'
                ]),
                event.recipes.createFilling('kubejs:incomplete_calculation_processor', [
                    'kubejs:incomplete_calculation_processor',
                    Fluid.of('immersiveengineering:redstone_acid', 250)
                ])
            ]
        )
        .transitionalItem('kubejs:incomplete_calculation_processor')
        .loops(1)
        .id(`mbm2:calculation_processor`);
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes
                    .createCutting('kubejs:incomplete_printed_logic_processor', [
                ...
                event.recipes
                    ...
                    .processingTime(100),
                event.recipes.createPressing('kubejs:incomplete_printed_logic_processor', [
                    'kubejs:incomplete_printed_logic_processor'
                ])
            ]
        )
        .transitionalItem('kubejs:incomplete_printed_logic_processor')
        .loops(1)
        .id(`mbm2:printed_logic_processor`);
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createDeploying('kubejs:incomplete_logic_processor', [
                    'kubejs:incomplete_logic_processor',
                    'ae2:printed_silicon'
                ]),
                event.recipes.createFilling('kubejs:incomplete_logic_processor', [
                    'kubejs:incomplete_logic_processor',
                    Fluid.of('immersiveengineering:redstone_acid', 250)
                ])
            ]
        )
        .transitionalItem('kubejs:incomplete_logic_processor')
        .loops(1)
        .id(`mbm2:logic_processor`);
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes
                    .createCutting('kubejs:incomplete_printed_engineering_processor', [
                        'kubejs:incomplete_printed_engineering_processor'
                    ])
                    .processingTime(100),
                event.recipes.createPressing('kubejs:incomplete_printed_engineering_processor', [
                    'kubejs:incomplete_printed_engineering_processor'
                ]),
                event.recipes
                    .createCutting('kubejs:incomplete_printed_engineering_processor', [
        ...
        .transitionalItem('kubejs:incomplete_printed_engineering_processor')
        .loops(1)
        .id(`mbm2:printed_engineering_processor`);
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createDeploying('kubejs:incomplete_engineering_processor', [
                    'kubejs:incomplete_engineering_processor',
                    'ae2:printed_silicon'
                ]),
                event.recipes.createFilling('kubejs:incomplete_engineering_processor', [
                    'kubejs:incomplete_engineering_processor',
                    Fluid.of('immersiveengineering:redstone_acid', 250)
                ])
            ]
        )
        .transitionalItem('kubejs:incomplete_engineering_processor')
        .loops(1)
        .id(`mbm2:engineering_processor`);
    ...
    global.ieBlueprint(
        ...
        [
            ...
            { count: 2, base_ingredient: { tag: 'forge:wires/red_alloy' } }
        ],
        `mbm2:immersive/formation_core`
    );
    ...
    global.ieBlueprint(
        ...
        [
            { item: `ae2:logic_processor` },
            { item: 'ae2:fluix_crystal' },
            { count: 2, base_ingredient: { tag: 'forge:wires/electrum' } }
        ],
        `mbm2:immersive/annihilation_core`
    );
    ...
    event
        .shaped('ae2:controller', ['HCH', 'GSG', 'HCH'], {
    ...
    event
        .shaped('ae2:energy_acceptor', ['HRH', 'GSG', 'HCH'], {
    ...
    event
        .shaped('ae2:semi_dark_monitor', [' GQ', 'PRQ', ' GQ'], {
    ...
    event
        .shaped('ae2:terminal', ['PTP', 'ASA', 'PCP'], {
    ...
    event
        .shaped('ae2:crafting_terminal', ['PTP', 'ASF', 'PCP'], {
    ...
    event
        .shaped('ae2:storage_bus', [' IG', 'CPU', ' SG'], {
    ...
    //laser_diode
    event
        .shaped('thermal:laser_diode', [' FG', 'REF', ' R '], {
            F: '#forge:dusts/fluix',
    ...
    event
        .shaped('ae2:inscriber', ['PSP', 'D  ', 'PSP'], {
            P: '#forge:plates/hepatizon',
    ...
    event
        .shaped('ae2:interface', ['PQP', 'FEA', 'PGP'], {
    ...
    //Alt Recipe
    event
        .shaped('ae2:pattern_provider', ['PEP', 'FCF', 'PQP'], {
    ...
    event
        .shaped('ae2:crafting_unit', ['PEP', 'CSC', 'PEP'], {
    ...
    event
        .shaped('ae2:molecular_assembler', ['CQC', 'FEA', 'CQC'], {
    ...
    //Early Recipe
    event
        .shaped('ae2:blank_pattern', ['ABA', 'CDC', 'EEE'], {
            A: 'minecraft:glowstone_dust',
            B: 'create:precision_mechanism',
            C: 'ae2:quartz_glass',
            D: 'immersiveengineering:slab_treated_wood_horizontal',
            E: 'kubejs:energetic_alloy_plate'
        })
        .id('mbm2:blank_pattern');
    //2x Recipe
    event
        .shaped('2x ae2:blank_pattern', ['GEG', 'QFQ', 'PPP'], {
    ...
    event
        .shaped('8x ae2:fluix_covered_cable', ['CCC', 'CBC', 'CCC'], {
            C: 'ae2:fluix_glass_cable',
    ...
    global.ieBottling(
        event,
        [Item.of('ae2:fluix_covered_cable').toJson()],
        Item.of('ae2:fluix_glass_cable').toJson(),
        { tag: 'forge:latex', amount: 100 },
        'mbm2:bottling/fluix_covered_cable'
    );
    ...
    global.mekanismMetallurgicInfusing(
        event,
        Item.of('lazierae2:resonating_crystal'),
        Item.of('kubejs:resonating_dust'),
        'mekanism:diamond',
        20,
        `mbm2:infusing/resonating_crystal`
    );

    event.recipes
        .createFilling('kubejs:resonating_dust', [Fluid.of('thermal:ender', 250), 'ae2:sky_dust'])
        .id('mbm2:filling/resonating_dust');
    event.recipes.tconstruct
        .casting_table('kubejs:resonating_dust', 'thermal:ender', 250)
        .cast('ae2:sky_dust')
        .consumeCast()
        .coolingTime(100)
        .id(`mbm2:casting/resonating_dust`);
    ...
    event.recipes.botania
        .pure_daisy('beyond_earth:sky_stone', 'ae2:smooth_sky_stone_block')
        .id(`mbm2:reverse_skystone_conversion`);
    event.recipes.botania
        .pure_daisy('ae2:sky_stone_block', 'beyond_earth:sky_stone')
        .id(`mbm2:skystone_conversion`);

    event.recipes.tconstruct
        .casting_table('ae2:calculation_processor_press', 'tconstruct:molten_steel', 810)
        .cast('ae2:calculation_processor')
        .consumeCast()
        .coolingTime(180)
        .id(`mbm2:casting/ae2_press_calculation`);
    event.recipes.tconstruct
        .casting_table('ae2:engineering_processor_press', 'tconstruct:molten_steel', 810)
        .cast('ae2:engineering_processor')
        .consumeCast()
        .coolingTime(180)
        .id(`mbm2:casting/ae2_press_engineering`);
    event.recipes.tconstruct
        .casting_table('ae2:logic_processor_press', 'tconstruct:molten_steel', 810)
        .cast('ae2:logic_processor')
        .consumeCast()
        .coolingTime(180)
        .id(`mbm2:casting/ae2_press_logic`);
    event.recipes.tconstruct
        .casting_table('ae2:silicon_press', 'tconstruct:molten_steel', 810)
        .cast('ae2:printed_silicon')
        .consumeCast()
        .coolingTime(180)
        .id(`mbm2:casting/ae2_press_silicon`);
    ...
    if (ae2aLoaded) {
        ...
        event.replaceInput(
            { id: 'ae2_additions:network/crafting/pattern_provider_2th_gen' },
            'ae2:fluix_block',
            'powah:uraninite_block'
        );

        event
            .shaped('ae2_additions:pattern_provider_3th', ['ABA', 'CDC', 'ABA'], {
                A: 'kubejs:lunar_alloy_plating',
                B: 'laserio:logic_chip',
                C: 'pneumaticcraft:module_expansion_card',
                D: 'ae2_additions:pattern_provider_2th'
            })
            .id(`mbm2:pattern_provider_3rd`);

        event
            .shaped('ae2_additions:pattern_provider_4th', ['ABA', 'CDC', 'ABA'], {
                A: 'kubejs:space_alloy_plating',
                B: 'lazierae2:parallel_processor',
                C: 'mekanism:ultimate_control_circuit',
                D: 'ae2_additions:pattern_provider_3th'
            })
            .id(`mbm2:pattern_provider_4th`);
    }
    ...
    global.thermalCrystallizer(
        ...
        'water',
        2000,
        Item.of('ae2:certus_quartz_crystal').toResultJson(),
        '#forge:dusts/certus_quartz',
        `mbm2:crystallizer/certus_quartz_from_dust`
    );
    global.thermalCrystallizer(
        event,
        'water',
        2000,
        Item.of('ae2:fluix_crystal').toResultJson(),
        '#forge:dusts/fluix',
        `mbm2:crystallizer/fluix_from_dust`
    );
    ...
    global.thermalCrystallizer(
        ...
        'water',
        2000,
        Item.of(`#forge:gems/fluix`).toResultJson(),
        'ae2:fluix_crystal_seed',
        `mbm2:crystallizer/growing_fluix`
    );
    global.thermalCrystallizer(
        event,
        'water',
        2000,
        Item.of(`#forge:gems/certus_quartz`).toResultJson(),
        'ae2:certus_crystal_seed',
        `mbm2:crystallizer/growing_certus`
    );

    //logic_unit
    event.remove({ output: 'lazierae2:logic_unit' });
    event
        .shaped('kubejs:unfinished_logic_unit', ['FFF', 'ABA', 'CCC'], {
            A: 'pneumaticcraft:plastic',
            B: 'ae2:logic_processor',
            C: 'kubejs:fluix_steel_plate',
            F: 'kubejs:shaped_fluix_crystal'
        })
        .id(`mbm2:unfinished_logic_unit`);
    global.AssemblyLaser(
        event,
        'lazierae2:logic_unit',
        `kubejs:unfinished_logic_unit`,
        `mbm2:finished_logic_unit`
    );

    //crystal_growth
    event.remove({ output: 'ae2things:crystal_growth' });
    event
        .shaped('ae2things:crystal_growth', ['ABA', 'CDC', 'AEA'], {
        ...
        .id(`mbm2:crystal_growth`);
    //aggregator
    event.remove({ output: 'lazierae2:aggregator' });
    event
        .shaped('lazierae2:aggregator', ['ABA', 'CDC', 'EFE'], {
            A: 'lazierae2:fluix_steel_ingot',
            B: 'ae2:charger',
            C: 'lazierae2:parallel_processor',
            D: 'lazierae2:logic_unit',
            E: 'ae2:dense_energy_cell',
            F: 'ae2things:crystal_growth'
        })
        .id(`mbm2:aggregator`);

    // Shaped Fluix
    event.recipes
        .createCutting('kubejs:shaped_fluix_crystal', 'ae2:fluix_crystal')
        .id('mbm2:cutting/shaped_fluix_crystal');
    event.recipes
        .mekanismSawing(`2x kubejs:shaped_fluix_crystal`, `ae2:fluix_crystal`)
        .id(`mbm2:mek_sawmill/shaped_fluix_crystal`);
    event
        .custom({
            type: 'immersiveengineering:sawmill',
            secondaries: [{ output: Item.of(`#forge:dusts/fluix`).toJson(), stripping: 'false' }],
    ...
    event
        .shaped('ae2:cell_component_1k', ['SQS', 'QPQ', 'SQS'], {
    ...
    event
        .shaped('ae2:cell_component_4k', ['SPS', 'KQK', 'SKS'], {
    ...
    event
        .shaped('ae2:cell_component_16k', ['ABA', 'CDC', 'ACA'], {
            A: 'kubejs:tier_1_electrical_alloy_plate',
            B: 'ae2:calculation_processor',
            C: 'ae2:cell_component_4k',
            D: 'pneumaticcraft:plastic'
        })
        .id(`mbm2:crafting/cell_component_16k`);

    //64k Storage Component
    event.remove({ output: 'ae2:cell_component_64k' });
    event
        .shaped('ae2:cell_component_64k', ['ABA', 'CDC', 'ACA'], {
            A: 'kubejs:tier_2_electrical_alloy_plate',
            B: 'ae2:calculation_processor',
            C: 'ae2:cell_component_16k',
            D: 'botania:mana_diamond'
        })
        .id(`mbm2:crafting/cell_component_64k`);

    //256k Storage Component
    event.remove({ output: 'ae2:cell_component_256k' });
    event
        .shaped('ae2:cell_component_256k', ['ABA', 'CDC', 'ACA'], {
            A: 'kubejs:tier_2_electrical_alloy_plate',
            B: 'ae2:calculation_processor',
            C: 'ae2:cell_component_64k',
            D: 'chemlib:lithium_dust'
        })
        .id(`mbm2:crafting/cell_component_256k`);

    //1kk Storage Component
    event.remove({ output: 'ae2_additions:cell_component_1kk' });
    event
        .shaped('ae2_additions:cell_component_1kk', ['ABA', 'CDC', 'ACA'], {
            A: 'kubejs:tier_3_electrical_alloy_plate',
            B: 'ae2:calculation_processor',
            C: 'ae2:cell_component_256k',
            D: 'minecraft:dragon_breath'
        })
        .id(`mbm2:crafting/cell_component_1kk`);

    //Basic Card
    event.remove({ output: 'ae2:basic_card' });
    event
        .shaped('ae2:basic_card', ['AB ', 'CDB', 'AB '], {
            A: 'minecraft:gold_ingot',
            B: 'kubejs:titanium_plate',
            C: 'kubejs:tier_2_electrical_alloy_spool',
            D: 'ae2:calculation_processor'
        })
        .id(`mbm2:crafting/basic_card`);

    //Advanced Card
    event.remove({ output: 'ae2:advanced_card' });
    event
        .shaped('ae2:advanced_card', ['AB ', 'CDB', 'AB '], {
            A: 'minecraft:diamond',
            B: 'kubejs:titanium_plate',
            C: 'kubejs:tier_2_electrical_alloy_spool',
            D: 'ae2:engineering_processor'
        })
        .id(`mbm2:crafting/advanced_card`);
});
