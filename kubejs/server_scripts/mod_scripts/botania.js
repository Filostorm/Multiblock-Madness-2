...
onEvent('recipes', (event) => {
    ...
    event.recipes.tconstruct
        .casting_table('botania:quartz_blaze', 'tconstruct:blazing_blood', 25)
        .cast('minecraft:quartz')
        .consumeCast()
        .coolingTime(80)
        .id(`mbm2:casting/quartz_blaze`);
    event.recipes.tconstruct
        .casting_table('botania:quartz_blaze', 'kubejs:blazing_pyrotheum', 25)
        .cast('minecraft:quartz')
        .consumeCast()
        .coolingTime(80)
        .id(`mbm2:casting/quartz_blaze/blazing_pyrotheum`);
    event.replaceInput(
        { id: 'lazierae2:compat/botania/infuser/quartz_blaze' },
    ...
    event.shaped('botania:apothecary_default', ['ABA', ' A ', 'AAA'], {
    ...
    event
        .shapeless('botania:apothecary_mossy', [
            'botania:apothecary_default',
            'minecraft:moss_block'
        ])
        .id('mbm2:moss_apothecary');
    event
        .shapeless('botania:apothecary_mossy', ['botania:apothecary_default', 'minecraft:vine'])
        .id('mbm2:vine_apothecary');
    ...
    event
        .shaped('8x botania:dry_grass', ['DDD', 'DSD', 'DDD'], {
            D: '#minecraft:dirt',
            S: 'botania:dry_seeds'
        })
        .id('mbm2:dry_grass');
    event
        .shaped('8x botania:golden_grass', ['DDD', 'DSD', 'DDD'], {
            D: '#minecraft:dirt',
            S: 'botania:golden_seeds'
        })
        .id('mbm2:golden_grass');
    event
        .shaped('8x botania:vivid_grass', ['DDD', 'DSD', 'DDD'], {
            D: '#minecraft:dirt',
            S: 'botania:vivid_seeds'
        })
        .id('mbm2:vivid_grass');
    event
        .shaped('8x botania:scorched_grass', ['DDD', 'DSD', 'DDD'], {
            D: '#minecraft:dirt',
            S: 'botania:scorched_seeds'
        })
        .id('mbm2:scorched_grass');
    event
        .shaped('8x botania:infused_grass', ['DDD', 'DSD', 'DDD'], {
            D: '#minecraft:dirt',
            S: 'botania:infused_seeds'
        })
        .id('mbm2:infused_grass');
    event
        .shaped('8x botania:mutated_grass', ['DDD', 'DSD', 'DDD'], {
            D: '#minecraft:dirt',
            S: 'botania:mutated_seeds'
        })
        .id('mbm2:mutated_grass');
    event
        .shapeless('botania:enchanted_soil', ['botania:overgrowth_seed', '#minecraft:dirt'])
        .id('mbm2:enchanted_soil');
    ...
    let calcinatedgem = ['coal', 'diamond', 'emerald', 'lapis', 'redstone'];
    calcinatedraw.forEach((material) => {
        event.recipes.botania
            .brew(`kubejs:${material}_sight`, [
                'minecraft:nether_wart',
                `potionsmaster:calcinated${material}_powder`,
                `#forge:storage_blocks/raw_${material}`
            ])
            .id(`mbm2:${material}_sight`);
    });
    ...
    event.recipes.botania
        .brew('kubejs:aluminium_sight', [
            'minecraft:nether_wart',
            'potionsmaster:calcinatedaluminium_powder',
            '#forge:storage_blocks/raw_aluminum'
        ])
        .id('mbm2:aluminum_sight');
    event.recipes.botania
        .brew('kubejs:quartz_sight', [
            'minecraft:nether_wart',
            'potionsmaster:calcinatedquartz_powder',
            'minecraft:quartz_block'
        ])
        .id('mbm2:quartz_sight');
    event.recipes.botania
        .brew('kubejs:netherite_sight', [
            'minecraft:nether_wart',
            'potionsmaster:calcinatednetherite_powder',
            '#mbm2:brewery_debris'
        ])
        .id('mbm2:debris_sight');

    event.recipes.botania.brew('kubejs:bargaining', [
        'minecraft:nether_wart',
        'minecraft:golden_apple',
        Item.of('minecraft:potion', '{Potion:"potionsmaster:emerald_sight"}')
    ]);
    event.recipes.botania.brew('kubejs:greater_bargaining', [
        'minecraft:nether_wart',
    ...
    event.recipes.botania
        .runic_altar(
            ...
            [
                ...
                '#forge:dusts/cryotheum',
                'quark:blue_rune',
                '#elementalcraft:gems/fine_water'
            ],
            5200
        )
    ...
    event.recipes.botania
        .runic_altar(
            ...
            [
                'botania:mana_powder',
                'botania:manasteel_ingot',
                '#forge:dusts/petrotheum',
                'quark:lime_rune',
                '#elementalcraft:gems/fine_earth'
            ],
            5200
        )
    ...
    event.recipes.botania
        .runic_altar(
            'botania:rune_mana',
            [
                'elementalcraft:shrine_upgrade_core',
                'botania:mana_pearl',
                'botania:mana_pearl',
                'quark:purple_rune',
                'botania:manasteel_ingot',
        ...
        .id('mbm2:botania/runic_altar/rune_mana');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_spring');
    ...
    event.recipes.botania
        .runic_altar(
            ...
            [
                ...
                'elementalcraft:springaline_cluster',
                'quark:yellow_blossom_leaf_carpet'
            ],
            8000
        )
        .id('mbm2:botania/runic_altar/rune_summer');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_autumn');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_winter');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_lust');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_gluttony');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_greed');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_sloth');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_wrath');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_envy');
    ...
    event.recipes.botania
        ...
        .id('mbm2:botania/runic_altar/rune_pride');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_asgard');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_vanaheim');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_alfheim');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_midgard');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_joetunheim');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_muspelheim');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_niflheim');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_nidavellir');
    ...
    event.recipes.botania
        ...
        .id('mbm2:mythicbotany/runic_altar/rune_helheim');
    ...
    event
        .shaped('botania:mana_spreader', ['AAA', 'BC ', 'AAA'], {
            ...
            B: 'kubejs:nature_gem',
            C: 'botania:white_petal'
        })
        .id(`mbm2:mana_spreader`);

    //Astrolabe is NeStEd
    event.remove({ output: 'botania:astrolabe' });
    event.shaped('botania:astrolabe', [' AB', 'ACA', 'BAD'], {
