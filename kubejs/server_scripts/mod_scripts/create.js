...
onEvent('recipes', (event) => {
    ...
    event
        .shaped('2x create:belt_connector', ['AAA', 'AAA'], {
    ...
    event
        .shaped('4x create:andesite_funnel', ['B', 'C'], {
    ...
    event
        .shaped('4x create:brass_funnel', ['B', 'C', 'D'], {
    ...
    event
        .shaped('4x create:andesite_tunnel', ['AA', 'CC'], {
    ...
    // [| rubber/brass_tunnel |] //
    event
        .shaped('2x create:brass_tunnel', ['A ', 'CC', 'DD'], {
    ...
    event
        .shaped('4x createaddition:spool', ['P', 'S', 'P'], {
            P: '#forge:plates/iron',
    ...
    event.recipes
        ...
        .loops(1)
        .id('mbm2:create/precision_mechanism');
    global.ieBlueprint(
        event,
        'components',
        ...
        `mbm2:blueprint/precision_mechanism`
    );

    //Windmill
    event.remove({ id: 'create:crafting/kinetics/windmill_bearing' });
    event
        .shaped('create:windmill_bearing', ['BBB', 'SCS', 'SDS'], {
    ...
    event
        .shaped('2x create:sail_frame', ['BA', 'AB'], {
            A: 'create:andesite_alloy',
    ...
    event
        .shapeless('2x create:white_sail', [
            'create:sail_frame',
            'create:sail_frame',
            'immersiveengineering:hemp_fabric'
        ])
        .id('mbm2:create/sail_frame');
    ...
    event.recipes
        ...
        .id('mbm2:cutting/treated_slabs');
    event.recipes
        .createCutting('2x immersiveengineering:stick_treated', '#forge:treated_wood_slab')
        .id('mbm2:cutting/treated_sticks');
    ...
    event
        .shaped('create:andesite_alloy', ['AB', 'BA'], {
            A: 'minecraft:iron_nugget',
            B: '#forge:stone'
        })
        .id('mbm2:stone_alloy');
    event.recipes
        .createMixing([`create:andesite_alloy`], ['#forge:stone', 'minecraft:iron_nugget'])
        .id('mbm2:mixing/stone_alloy');
    ...
    event.recipes
        .createMixing(
            ...
            ['elementalcraft:whiterock', 'minecraft:iron_nugget']
        )
        .id(`mbm2:mixing/stone_alloy_x2`);

    /// Hose Pully w/o kelp
    event
        .shaped('create:hose_pulley', ['B', 'D', 'C'], {
            B: 'create:copper_casing',
            C: 'minecraft:chain',
    ...
    //Brass Upgrades
    event
        .shapeless('2x create:brass_funnel', [
            '#forge:ingots/brass',
            'create:electron_tube',
            'create:andesite_funnel'
        ])
        .id(`mbm2:create/brass_upgrade_funnel`);
    event
        .shapeless('2x create:brass_tunnel', [
            '#forge:ingots/brass',
            '#forge:ingots/brass',
            'create:electron_tube',
            'create:andesite_tunnel'
        ])
        .id(`mbm2:create/brass_upgrade_tunnel`);
    ...
    global.createApplying(
        event,
        'create:brass_casing',
        Ingredient.of('#forge:ingots/brass'),
        Ingredient.of('#forge:treated_wood'),
        `mbm2:applying/brass_casing`
    );
    ...
    global.elementalcraftInfusion(
        ...
        Item.of('kubejs:charred_planks'),
        'fire',
        250,
        'mbm:infusion/copper_casing'
    );
    ...
    event.recipes
        ...
        .id(`mbm2:crushing/leaves_into_saplings`);

    /// Blaze Burner
    event.remove({ id: 'create:crafting/kinetics/empty_blaze_burner' });
    event
        .shaped('create:empty_blaze_burner', ['RRR', 'R R', 'PNP'], {
            R: '#forge:rods/bronze',
    ...
    //Spirit Compat
    event.recipes
        .createHaunting('spirit:soul_powder', 'minecraft:glowstone_dust')
        .id('mbm2:haunting/soul_powder');
    event.recipes
        .createHaunting('spirit:soul_slate', 'minecraft:deepslate')
        .id('mbm2:haunting/soul_slate');

    /// Propeller
    event.remove({ id: 'create:crafting/kinetics/propeller' });
    event
        .shaped('create:propeller', [' A ', 'ACA', ' A '], {
            A: 'create:andesite_alloy',
            C: '#forge:gears/iron'
        })
    ...
    event
        .shaped('create:steam_engine', [' A ', 'PMP', ' B '], {
...
*/
    ...
    //Melt some Clay
    event.recipes
        .createMixing([Fluid.of('tconstruct:molten_clay', 1000)], ['clay', Fluid.of('water', 1000)])
        .id(`mbm2:mixing/clay_from_block`);
    event.recipes
        .createMixing(
            [Fluid.of('tconstruct:molten_clay', 250)],
            ['clay_ball', Fluid.of('water', 250)]
        )
        .id(`mbm2:mixing/clay_from_ball`);

    event.recipes
        .createMixing(
            [Fluid.of('immersiveengineering:redstone_acid', 250)],
            ['redstone', Fluid.of('water', 250)]
        )
        .id(`mbm2:mixing/redstone_acid`);
    ...
    event.recipes
        .createMilling(
            [
                ...
                Item.of('magma_cream').withChance(0.5),
                Item.of('magma_cream').withChance(0.5)
            ],
            ['minecraft:magma_block']
        )
        .id(`mbm2:create/crushing/magma_block`);

    //Magma
    event.recipes
        .createFilling('magma_block', [Fluid.of('tconstruct:magma', 500), 'create:scoria'])
        .id('mbm2:filling/magma_block_from_scoria');

    //Blood
    event.recipes
        .createMixing(
            [Fluid.of('tconstruct:blood', 50)],
            [Fluid.of('minecraft:water', 50), 'rotten_flesh']
        )
        .heated()
        .id('mbm2:mixing/blood');

    //Blazing Blood
    event.recipes
        .createMixing(
            [Fluid.of('tconstruct:blazing_blood', 500)],
            [Fluid.of('tconstruct:blood', 500), 'blaze_powder']
        )
        .superheated()
        .id('mbm2:mixing/blazing_blood');

    //Rose Quartz
    event
        .shapeless('4x create:rose_quartz', ['3x #forge:gems/quartz', 'thermal:cinnabar'])
        .id(`mbm2:create/rose_quartz_with_cinnabar`);

    //Soul Sand
    event.recipes
        .createCompacting(
            [`soul_sand`],
            ['#forge:netherrack', 'engineersdecor:dense_grit_sand_block']
        )
        .heated()
        .id('mbm2:mixing/soul_sand_smh');
