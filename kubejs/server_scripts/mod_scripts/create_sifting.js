onEvent('recipes', (event) => {
    ...
    //Gravel
    event.remove({ id: 'createsifter:sifting/gravel_andesite_mesh' });
    global.createSifting(
        event,
        [Item.of('createsifter:andesite_mesh').toJson(), Item.of('#forge:gravel').toJson()],
        [
            Item.of('#forge:ores/fragment/vincyte').withChance(0.1).toResultJson(),
            ...
            Item.of(`coal`).withChance(0.2).toResultJson(),
            Item.of(`flint`).withChance(0.33).toResultJson()
        ],
        500,
        'mbm2:sifting/gravel_andesite_mesh'
    );
    ...
    global.createSifting(
        event,
        [Item.of('createsifter:zinc_mesh').toJson(), Item.of('#forge:gravel').toJson()],
        [
            ...
            Item.of('#forge:ores/fragment/densite').withChance(0.1).toResultJson(),
            Item.of(`#forge:gems/lapis`).withChance(0.1).toResultJson(),
            Item.of(`coal`).withChance(0.25).toResultJson(),
            Item.of(`create:experience_nugget`).withChance(0.05).toResultJson()
        ],
        500,
        'mbm2:sifting/gravel_zinc_mesh'
    );
    ...
    global.createSifting(
        event,
        [Item.of('createsifter:brass_mesh').toJson(), Item.of('#forge:gravel').toJson()],
        [
            //Item.of('#forge:ores/fragment/vincyte').withChance(0.10).toResultJson(),
            Item.of('#forge:ores/fragment/jimmium').withChance(0.1).toResultJson(),
            //Item.of('#forge:ores/fragment/densite').withChance(0.05).toResultJson(),
            Item.of(`#forge:gems/lapis`).withChance(0.2).toResultJson(),
            Item.of(`create:experience_nugget`).withChance(0.1).toResultJson()
        ],
        500,
        'mbm2:sifting/gravel_brass_mesh'
    );

    //Netherrack
    global.createSifting(
        event,
        [Item.of('createsifter:brass_mesh').toJson(), Item.of('#forge:netherrack').toJson()],
        [
            Item.of('#forge:ores/fragment/imortite').withChance(0.1).toResultJson(),
            ...
            Item.of(`#forge:gems/sulfur`).withChance(0.2).toResultJson(),
        ...
        500,
        'mbm2:sifting/netherrack_brass_mesh'
    );
    ...
    global.createSifting(
        event,
        [
            Item.of('createsifter:brass_mesh').toJson(),
            Item.of('apotheosis:common_material').toJson()
        ],
        [
            Item.of('tconstruct:debris_nugget').withChance(0.9).toResultJson(),
            Item.of('tconstruct:debris_nugget').withChance(0.75).toResultJson(),
            Item.of('tconstruct:debris_nugget').withChance(0.5).toResultJson(),
            Item.of('tconstruct:debris_nugget').withChance(0.25).toResultJson(),
            Item.of('kubejs:steel_scraps').withChance(0.5).toResultJson(),
        ...
        500,
        'mbm2:sifting/common_material_brass_mesh'
    );

    //Arcane Sand w/Zinc
    global.createSifting(
        event,
        [Item.of('createsifter:zinc_mesh').toJson(), Item.of('kubejs:arcane_sand').toJson()],
        [
        ...
        500,
        'mbm2:sifting/arcane_sand_zinc_mesh'
    );

    //Arcane Sand w/Brass
    global.createSifting(
        event,
        [Item.of('createsifter:brass_mesh').toJson(), Item.of('kubejs:arcane_sand').toJson()],
        [
            Item.of('forbidden_arcanus:arcane_crystal_dust_speck').withChance(0.5).toResultJson(),
            Item.of('elementalcraft:inert_crystal').withChance(0.33).toResultJson(),
            Item.of('create:experience_nugget').withChance(0.1).toResultJson(),
            Item.of('botania:fertilizer').withChance(0.5).toResultJson()
        ],
        500,
        'mbm2:sifting/arcane_sand_brass_mesh'
    );
});
