...
onEvent('recipes', (event) => {
    ...
    ExtendedRecipes.forEach((item) => {
        ...
        event
            .shaped(`extendedcrafting:${item.type}_component`, ['AAB', 'CDA', 'CCA'], {
                A: item.flavor_item,
        ...
        event
            .shaped(`extendedcrafting:${item.type}_catalyst`, ['ABA', 'BCB', 'ABA'], {
    ...
    event
        .shaped('extendedcrafting:basic_table', ['ABA', 'CDC', 'AEA'], {
            A: 'extendedcrafting:basic_component',
            B: 'extendedcrafting:basic_catalyst',
            C: 'ars_nouveau:glyph_craft',
            D: 'kubejs:white_alloy_storage_block',
            E: 'extendedcrafting:pedestal'
        })
        .id('mbm2:ex_crafting/basic_table');
    event.remove({ output: 'extendedcrafting:advanced_table' });
    event
        .shaped('extendedcrafting:advanced_table', ['ABA', 'CDC', 'AEA'], {
            A: 'extendedcrafting:advanced_component',
            B: 'extendedcrafting:advanced_catalyst',
            C: 'ars_nouveau:glyph_craft',
            D: 'kubejs:lunar_alloy_storage_block',
            E: 'extendedcrafting:basic_table'
        })
        .id('mbm2:ex_crafting/advanced_table');
    event.remove({ output: 'extendedcrafting:elite_table' });
    event.recipes
        .createMechanicalCrafting('extendedcrafting:elite_table', ['ECE', 'RBR', 'ETE'], {
    ...
    event
        .shaped('packagedexcrafting:basic_crafter', ['ABA', 'CDC', 'AEA'], {
            A: 'kubejs:black_iron_plate',
            B: 'packagedauto:me_package_component',
            C: 'ae2:molecular_assembler',
            D: 'extendedcrafting:redstone_catalyst',
            E: 'extendedcrafting:basic_table'
        })
        .id('mbm2:ex_crafting/basic_packager');
    event.remove({ output: 'packagedexcrafting:advanced_crafter' });
    event
        .shaped('packagedexcrafting:advanced_crafter', ['ABA', 'CDC', 'AEA'], {
            A: 'extendedcrafting:advanced_component',
            B: 'extendedcrafting:advanced_catalyst',
            C: 'ae2:molecular_assembler',
            D: 'kubejs:lunar_alloy_storage_block',
            E: 'packagedexcrafting:basic_crafter'
        })
        .id('mbm2:ex_crafting/advanced_packager');
    ...
    event.recipes
        .createMechanicalCrafting(
            ...
            ['  FFF  ', ' AABAA ', 'FACDCAF', 'FCDBDCF', 'FACDCAF', ' BAEAB ', '  FFF  '],
            {
                A: 'extendedcrafting:ultimate_component',
                B: 'extendedcrafting:ultimate_catalyst',
                C: 'kubejs:assembly_rune',
    ...
    event
        .custom({
            ...
            pattern: ['ABBBBBA', 'ACDEDCA', 'ACDEDCA', 'ABBBBBA'],
            key: {
                A: {
