...
onEvent('recipes', event => {
	...
	event.shaped('extendedcrafting:ultimate_component', ['AAB','CDA','CCA'], {A: '#forge:spools/beryllium',B: 'extendedcrafting:luminessence',C: 'extendedcrafting:black_iron_slate',D: 'powah:dielectric_paste'}).id('mbm2:ex_crafting/ultimate_component')
