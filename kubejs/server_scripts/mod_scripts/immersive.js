...
onEvent('recipes', (event) => {
    ...
    event
        .shaped('immersiveengineering:hammer', ['ABC', 'ADB', 'DAA'], {
            A: Item.empty,
    ...
    event
        .shapeless('4x engineersdecor:dense_grit_sand_block', [
            'minecraft:dirt',
            'minecraft:gravel',
            'minecraft:sand',
            'minecraft:sand'
        ])
        .id(`mbm2:shapeless/dense_grit_sand_block`);
    ...
    event
        .shaped('immersiveengineering:cokebrick', ['AA', 'AA'], {
    ...
    event.recipes
        .createCompacting('immersiveengineering:alloybrick', [
            '2x kubejs:unfired_clay_brick',
            '2x engineersdecor:dense_grit_sand_block'
        ])
        .heated()
        .id(`mbm2:compacting/kiln_bricks`);

    //Blast Bricks
    //Moved to new_material_recipes
    event.remove({ id: 'immersiveengineering:crafting/blastbrick' });
    event
        .shaped('immersiveengineering:blastbrick', ['AA', 'AA'], {
    ...
    event.recipes
        .createFilling('immersiveengineering:blastbrick_reinforced', [
            Fluid.of('tconstruct:molten_steel', 180),
            'immersiveengineering:blastbrick'
        ])
        .id('mbm2:filling/blastbrick_reinforced');
    ...
    event.recipes
        ...
        .loops(1); // transitional item and the loops
...
*/
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createDeploying('kubejs:incomplete_component_electronic', [
                    'kubejs:incomplete_component_electronic',
                    '#forge:gems/quartz'
                ]),
                event.recipes.createDeploying('kubejs:incomplete_component_electronic', [
                    'kubejs:incomplete_component_electronic',
        ...
        .transitionalItem('kubejs:incomplete_component_electronic')
        .loops(1); // transitional item and the loops
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createDeploying('kubejs:incomplete_component_electronic_adv', [
                    'kubejs:incomplete_component_electronic_adv',
        ...
        .transitionalItem('kubejs:incomplete_component_electronic_adv')
        .loops(2); // transitional item and the loops
    /*
...
*/
    ...
    //Belt
    event.shaped('8x immersiveengineering:conveyor_basic', ['BBB', 'CDC'], {
    ...
    // [| Treated Scaffolding |] //
    event
        .shaped('3x immersiveengineering:treated_scaffold', ['AAA', ' C ', 'C C'], {
    ...
    global.naturesauraAltar(
        event,
        'kubejs:living_metal_seed',
        'kubejs:metal_seed',
        'kubejs:overgrown_light_engineering_block',
        'overworld',
        7500,
        200,
        'mbm2:altar/living_metal_seed'
    );
    ...
    event
        .shaped('2x immersiveengineering:heavy_engineering', ['CBC', 'PDP', 'CBC'], {
    ...
    event
        .shaped('2x immersiveengineering:light_engineering', ['PCB', 'CEC', 'BCP'], {
    ...
    event
        .shaped('2x immersiveengineering:generator', ['PDC', 'DBD', 'CDP'], {
    ...
    event
        .shaped('immersiveengineering:rs_engineering', ['DCD', 'PBP', 'DCD'], {
    ...
    event
        .shaped('immersiveengineering:radiator', ['CPC', 'PBP', 'CPC'], {
    ...
    event
        .shaped('3x immersiveengineering:radiator', ['CPC', 'PBP', 'CPC'], {
    ...
    event
        .blasting('immersiveengineering:slag_glass', 'kubejs:slag_dust')
        .id(`mbm2:blasting/slag_glass`);

    //Workbench
    event.remove({ id: 'immersiveengineering:crafting/workbench' });
    event
        .shaped('immersiveengineering:workbench', ['PTT', 'C F'], {
    ...
    event
        .shaped(
            Item.of('immersiveengineering:blueprint', '{blueprint:"interlocking_components"}'),
            [' G ', 'BBB', 'PPP'],
            {
                G: '#forge:gears/steel',
                P: 'paper',
    ...
    event
        .shaped(
            Item.of('immersiveengineering:blueprint', '{blueprint:"mechanical_components"}'),
            [' G ', 'BBB', 'PPP'],
            {
    ...
    event
        .shaped('8x immersiveengineering:hempcrete', ['CCC', 'HGH', 'CCC'], {
...
*/
    ...
    event
        .custom({
            ...
            pattern: ['www', 'wbw', 'www'],
            key: {
                w: { item: 'thermal:sawdust_block' },
                b: { tag: 'forge:phenolic_resin', amount: 1000, type: 'immersiveengineering:fluid' }
            },
            result: { item: 'immersiveengineering:fiberboard', count: 8 }
        })
        .id('mbm2:crafting/fiberboard');

    event.recipes.thermal
        .bottler('immersiveengineering:fiberboard', [
            'thermal:sawdust_block',
            Fluid.of('immersiveengineering:phenolic_resin', 125)
        ])
        .id(`mbm2:thermal/bottling/fiberboard`);
    ...
    //survey_tools
    event
        .shapeless('immersiveengineering:survey_tools', [
            'immersiveengineering:toolbox',
            'minecraft:book',
            'scannable:common_ores_module'
        ])
        .id(`mbm2:shapeless/survey_tools`);
});
