onEvent('recipes', (event) => {
    //Small Battery
    event
        .shaped('kubejs:small_battery_empty', ['TBT', 'LCL', 'LCL'], {
            T: '#forge:plates/tin',
            L: '#forge:plates/lead',
    ...
    // Large Battery
    event
        .shaped('kubejs:large_battery_empty', ['AAA', 'BCB', 'BDB'], {
            A: 'kubejs:stainless_steel_plate',
            B: '#forge:platings/advanced_battery_alloy',
            C: 'kubejs:small_battery_empty',
            D: 'kubejs:tier_1_electrical_alloy_wire_coil'
        })
        .id('mbm2:large_battery');

    //energy_crystal_empty
    event
        .shaped('kubejs:energy_crystal_empty', [' A ', 'BCB', ' D '], {
            A: 'kubejs:large_battery_full',
            B: 'extendedcrafting:basic_catalyst',
            C: 'botania:mana_diamond',
            D: 'immersiveengineering:redstone_acid_bucket'
        })
        .id('mbm2:energy_crystal_empty');

    //energy_orb_empty
    event
        .shaped('kubejs:energy_orb_empty', ['ABA', 'BCB', 'ABA'], {
            A: 'extendedcrafting:elite_catalyst',
            B: 'kubejs:energy_crystal_empty',
            C: 'elementalcraft:purecrystal'
        })
        .id('mbm2:energy_orb_empty');

    //lapatron_crystal_empty
    event
        .shaped('kubejs:lapatron_crystal_empty', ['ABA', 'BCB', 'ABA'], {
            A: 'extendedcrafting:ultimate_catalyst',
            B: 'kubejs:energy_orb_empty',
            C: 'forbidden_arcanus:dark_nether_star_block'
        })
        .id('mbm2:lapatron_crystal_empty');

    //lapatron_orb_empty
    event
        .shaped('kubejs:lapatron_orb_empty', ['ABA', 'BCB', 'ABA'], {
            A: 'extendedcrafting:crystaltine_catalyst',
            B: 'kubejs:lapatron_crystal_empty',
            C: 'ae2_additions:cell_component_1kkk_1th'
        })
        .id('mbm2:lapatron_orb_empty');

    //blank AI chip
    event
        .shaped('kubejs:blank_ai_chip', ['ABA', 'BCB', 'ABA'], {
            A: 'kubejs:reinforced_hdpe_sheet',
            B: 'kubejs:tier_3_electrical_alloy_wire',
            C: 'pneumaticcraft:unassembled_pcb'
        })
        .id('mbm2:blank_ai_chip');

    //ai_chip
    event
        .shaped('kubejs:ai_chip', ['ABA', 'BCB', 'ABA'], {
            A: 'hostilenetworks:empty_prediction',
            B: 'laserio:logic_chip',
            C: 'kubejs:blank_ai_chip'
        })
        .id('mbm2:ai_chip');
    ...
    event
        .custom({
            ...
            pattern: ['AAAAA', 'BBBBB', 'CDEDC', 'CCCCC'],
            key: {
                A: {
    ...
    global.mekanismInfusionConversion(
        event,
        Ingredient.of('#ae2:interface'),
        'kubejs:data',
        25,
        'mbm2:infuse/data_from_interface'
    );
    event.recipes
        .mekanismMetallurgicInfusing('kubejs:data_casing', Item.of('kubejs:space_age_casing'), {
            infuse_type: 'kubejs:data',
            amount: 100
        })
        .id(`mbm2:data_casing`);
    ...
    global.mekanismInfusionConversion(
        ...
        'kubejs:dimensional',
        50,
        'mbm2:infuse/dimensionalshard'
    );
    global.mekanismInfusionConversion(
        event,
        Item.of('kubejs:enriched_dimensional_shard'),
        'kubejs:dimensional',
        100,
        'mbm2:infuse/enriched_dimensionalshard'
    );
    event.recipes.mekanismEnriching(
        'kubejs:enriched_dimensional_shard',
        'rftoolsbase:dimensionalshard'
    );
    event.recipes
        .mekanismMetallurgicInfusing(
            'kubejs:raw_dimensional_wafer',
            Item.of('kubejs:iridium_infused_wafer'),
            { infuse_type: 'kubejs:dimensional', amount: 100 }
        )
        .id(`mbm2:raw_dimensional_wafer`);

    //iridium_infused_wafer
    event
        .shaped('kubejs:iridium_infused_wafer', ['AAA', 'ABA', 'AAA'], {
            A: 'chemlib:iridium',
            B: 'projectred_core:electrotine_silicon'
        })
        .id('mbm2:iridium_infused_wafer');

    //dimensional_alloy
    event.recipes
        .mekanismMetallurgicInfusing('kubejs:dimensional_alloy', Item.of('mekanism:alloy_atomic'), {
            infuse_type: 'kubejs:dimensional',
            amount: 50
        })
        .id(`mbm2:dimensional_alloy`);
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['ABBBA', 'BCDCB', 'B E B', 'BCFCB', 'ABBBA'],
            key: {
                A: {
