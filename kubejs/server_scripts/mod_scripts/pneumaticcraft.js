...
onEvent('recipes', (event) => {
    ...
    global.pressureChamber(
        event,
        [Item.of('2x #forge:ingots/pressurized_aluminum_alloy')],
        [
            { type: 'pneumaticcraft:stacked_item', tag: 'forge:ingots/aluminum', count: 2 },
            { tag: 'forge:ingots/cobalt' },
            { tag: 'forge:ingots/magnesium' }
        ],
        2.0,
        'mbm2:pressure_chamber/high_strength_ingot'
    );
    ...
    global.pressureChamber(
        event,
        [Item.of('pneumaticcraft:turbine_blade').toResultJson()],
        [
            { type: 'pneumaticcraft:stacked_item', tag: 'forge:ingots/nethersteel', count: 4 },
            { tag: 'forge:dusts/magnesium' },
            { item: 'kubejs:blazing_redstone' }
        ],
        2.0,
        'mbm2:pressure_chamber/turbine_blade'
    );
    ...
    global.pressureChamber(
        event,
        [Item.of('pneumaticcraft:empty_pcb').toResultJson()],
        [
            { type: 'pneumaticcraft:stacked_item', tag: 'forge:wires/red_alloy', count: 2 },
            { type: 'pneumaticcraft:stacked_item', tag: 'forge:sheets/electrum', count: 4 },
            { item: 'pneumaticcraft:plastic' }
        ],
        2.0,
        'mbm2:pressure_chamber/empty_pcb'
    );
    ...
    global.createApplying(
        ...
        Ingredient.of('#forge:ingots/compressed_steel'),
        Ingredient.of('#forge:treated_wood'),
        `mbm2:applying/compressed_steel_casing`
    );

    //PCB Blueprint
    event
        .shaped('pneumaticcraft:pcb_blueprint', ['UEU', 'WPW', 'UCU'], {
    ...
    event
        .shaped('4x pneumaticcraft:reinforced_stone', ['SRS', 'R R', 'SRS'], {
            S: '#forge:stone',
    ...
    //Casing
    event
        .shaped('kubejs:pneumaticcraft_casing', ['PPP', 'SCS', 'STS'], {
    ...
    event
        .shaped('pneumaticcraft:air_compressor', [' P ', 'TCT', 'GFG'], {
    ...
    event
        .shaped('pneumaticcraft:thermopneumatic_processing_plant', ['GPG', 'HCH', 'RFR'], {
    ...
    event
        .shaped('pneumaticcraft:refinery', ['PEP', 'HCH', 'PFP'], {
            E: 'immersiveengineering:component_electronic_adv',
    ...
    event
        .shaped('pneumaticcraft:refinery_output', ['RDR', 'HCH', 'RDR'], {
            H: 'thermal:obsidian_glass',
    ...
    event
        .shaped('pneumaticcraft:fluid_mixer', [' R ', 'HCH', 'RPR'], {
    ...
    event
        .shaped('4x pneumaticcraft:thermal_lagging', ['WGW', 'GPG', 'WGW'], {
            G: 'ae2:quartz_glass',
    ...
    event.recipes
        .createMechanicalCrafting(
            'compressedcreativity:rotational_compressor',
            ['  BBB  ', 'BBECEBB', 'BMCRCMB', 'BBECEBB', '  BBB  '],
            {
    ...
    event
        .shaped('pneumaticcraft:pneumatic_dynamo', [' A ', 'BCB', 'DED'], {
        ...
        .id('mbm2:pneumatic_dynamo');

    //transistor
    event.remove({ id: 'pneumaticcraft:pressure_chamber/transistor' });
    event
        .shaped('pneumaticcraft:transistor', ['ABA', 'ACA', 'DDD'], {
            A: 'kubejs:lead_sheet',
            B: 'pneumaticcraft:plastic',
            C: 'projectred_core:silicon',
            D: 'kubejs:tier_2_electrical_alloy_wire'
        })
        .id('mbm2:transistor');
    ...
    event
        .shaped('pneumaticcraft:capacitor', ['ABA', 'ACA', 'DDD'], {
            A: 'kubejs:cobalt_sheet',
            B: 'pneumaticcraft:plastic',
            C: 'kubejs:battery_alloy_plate',
            D: 'kubejs:tier_2_electrical_alloy_wire'
        })
        .id('mbm2:capacitor');
});
