...
onEvent('recipes', (event) => {
    ...
    //Dielectric Casing
    event
        .shaped('powah:dielectric_casing', ['SPS', 'S S', 'SPS'], {
    ...
    event
        .shaped('2x powah:capacitor_basic_tiny', ['  C', ' I ', 'C  '], {
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createDeploying('kubejs:incomplete_basic_capacitor', [
                    'kubejs:incomplete_basic_capacitor',
        ...
        .transitionalItem('kubejs:incomplete_basic_capacitor')
        .loops(2)
        .id(`mbd2:sequenced_assembly/capacitor_basic`);

    global.ieBlueprint(
        event,
        'components',
        Item.of(`2x powah:capacitor_basic`),
        [
            { tag: 'forge:rods/invar' },
            { tag: 'forge:wires/red_alloy' },
            { count: 2, base_ingredient: { item: `powah:dielectric_paste` } }
        ],
        `mbm2:immersive/capacitor_basic`
    );

    //Paste
    event.remove({ output: 'powah:dielectric_paste' });
    event.recipes
        .createMixing('8x powah:dielectric_paste', [
            '#minecraft:coals',
            '#forge:clay',
            Fluid.of('minecraft:lava', 250)
        ])
        .id(`mbd2:mixing/dielectric_paste`);
    event.recipes
        .createMixing('8x powah:dielectric_paste', ['#minecraft:coals', '#forge:clay'])
        .heated()
        .id(`mbd2:mixing/dielectric_paste_heated`);
    ...
    // [| energy_hopper_basic |] //
    event
        .shaped('powah:energy_hopper_basic', ['AAA', 'BCB', 'ADA'], {
    ...
    event
        .shaped('powah:player_transmitter_basic', [' B ', 'CDC', ' E '], {
    ...
    // [| reactor_basic |] //
    event
        .shaped('4x powah:reactor_basic', ['ABA', 'BCB', 'ABA'], {
            A: 'powah:uraninite',
            B: 'powah:capacitor_basic',
            C: 'powah:dielectric_casing'
        })
...
*/
    ...
    // [| battery_basic |] //
    event
        .shaped('powah:battery_basic', ['ABA', 'BCB', 'ABA'], {
            A: 'powah:dielectric_paste',
    ...
    event
        .shaped('powah:energizing_rod_basic', ['ABA', 'CDC', 'AEA'], {
            A: Item.empty,
    ...
    event
        .shaped('powah:thermoelectric_plate', ['RCR', 'CGC', 'RCR'], {
    ...
    powahToSwap.forEach((machine) => {
        event.replaceInput(
            { output: machine },
            '#forge:ingots/iron',
            '#forge:plates/tier_1_electrical_alloy'
        );
    });
    ...
    // [| magmator_basic |] //
    event
        .shaped('powah:magmator_basic', ['AAA', 'BCB', 'ADA'], {
    ...
    event
        .shaped('powah:thermo_generator_basic', ['ABA', 'CDC', 'EEE'], {
            A: 'powah:dielectric_paste',
    ...
    // [| furnator_basic |] //
    event
        .shaped('powah:furnator_basic', ['AAA', 'BCB', 'ADA'], {
            A: '#forge:plates/tier_1_electrical_alloy',
            B: 'powah:capacitor_basic',
            C: 'powah:dielectric_casing',
            D: 'minecraft:furnace'
    ...
    global.powahEnergizing(
        event,
        [
            Item.of('solarflux:blazing_coating').toJson(),
            Item.of('reliquary:molten_core').toJson(),
            Item.of('botania:quartz_blaze').toJson()
        ],
        Item.of('powah:crystal_blazing'),
        120000,
        'mbm2:powah/blazing_crystal'
    );
    ...
    global.powahEnergizing(
        event,
        [
            Item.of('#forge:sprockets/tier_1_magical_alloy').toJson(),
            Item.of('kubejs:titanium_plated_obsidian').toJson(),
            Item.of('elementalcraft:springaline_shard').toJson(),
            Item.of('tconstruct:slimesteel_ingot').toJson()
        ],
        Item.of('powah:crystal_niotic'),
        300000,
        'mbm2:powah/niotic_crystal'
    );
    ...
    global.powahEnergizing(
        event,
        [
            Item.of('powah:spirited_crystal_block').toJson(),
            Item.of('powah:niotic_crystal_block').toJson(),
            Item.of('powah:blazing_crystal_block').toJson(),
            Item.of('kubejs:wixie_shard_block').toJson(),
            Item.of('kubejs:lithium_plating').toJson(),
            Item.of('beyond_earth:calorite_block').toJson()
        ],
        Item.of('powah:nitro_crystal_block'),
        20000000,
        'mbm2:powah/nitro_crystal'
    );

    // [| energizing_rod_basic |] //
    event.remove({ id: 'powah:crafting/energizing_rod_basic' });
    event
        .shaped('powah:energizing_rod_basic', [' A ', 'BCB', ' R '], {
    ...
    global.powahEnergizing(
        ...
        Item.of('powah:uraninite_block'),
        270000,
        'mbm2:powah/uranite_block'
    );

    //reactor recipe change
    event.remove({ id: 'powah:crafting/reactor_basic' });
    event
        .shaped('2x powah:reactor_basic', ['ABA', 'BCB', 'ABA'], {
            A: 'powah:uraninite',
            B: 'powah:capacitor_basic_large',
            C: 'powah:dielectric_casing'
        })
        .id('mbm2:powah/reactor_basic');
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['ABCDD', 'BEBFD', 'CBGBC', 'DFBEB', 'DDCBA'],
            key: {
                A: {
                    item: 'powah:reactor_niotic'
                },
