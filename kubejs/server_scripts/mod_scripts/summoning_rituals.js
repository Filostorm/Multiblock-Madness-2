onEvent('recipes', (event) => {
	...
	*/
    event.recipes.summoningrituals
        ...
        .mobOutput(SummoningOutput.mob('blaze').count(4).offset(0, 3, 0).spread(4, 0, 4))
        .input('soul_sand')
        ...
        .input('soul_lantern')
        .recipeTime(200)
        .id('kubejs:summoning/4x_blaze');

    event.recipes.summoningrituals
        .altar('forbidden_arcanus:soul')
        .mobOutput(SummoningOutput.mob('phantom').count(4).offset(0, 3, 0).spread(4, 0, 4))
        .input('#forge:leather')
        ...
        .input('soul_lantern')
        .recipeTime(200)
        .id('kubejs:summoning/4x_phantom');

    event.recipes.summoningrituals
        .altar('forbidden_arcanus:soul')
        .mobOutput(SummoningOutput.mob('artifacts:mimic').count(1).offset(0, 3, 0).spread(4, 0, 4))
        ...
        .recipeTime(200)
        .id('kubejs:summoning/mimic_expensive');
    ...
    event.recipes.summoningrituals
        ...
        .recipeTime(200)
        .id('kubejs:summoning/mimic_reroll');

    event.recipes.summoningrituals
        .altar('forbidden_arcanus:soul')
        .mobOutput(SummoningOutput.mob('elder_guardian').count(2).offset(0, 3, 0).spread(4, 0, 4))
    ...
    event.recipes.summoningrituals
        .altar('forbidden_arcanus:soul')
        .mobOutput(
            SummoningOutput.mob('naturalist:firefly').count(4).offset(0, 3, 0).spread(4, 0, 4)
        )
        .input('minecraft:torch')
        .input('minecraft:slime_ball')
        .input('minecraft:honeycomb')
        .recipeTime(200)
        .id('kubejs:summoning/4x_firefly');

    event.recipes.summoningrituals
        .altar('forbidden_arcanus:soul')
        .mobOutput(SummoningOutput.mob('thermal:blitz').count(4).offset(0, 3, 0).spread(4, 0, 4))
        ...
        .recipeTime(200)
        .id('kubejs:summoning/4x_blitz');

    event.recipes.summoningrituals
        .altar('forbidden_arcanus:soul')
        .mobOutput(SummoningOutput.mob('thermal:blizz').count(4).offset(0, 3, 0).spread(4, 0, 4))
        ...
        .recipeTime(200)
        .id('kubejs:summoning/4x_blizz');

    event.recipes.summoningrituals
        .altar('forbidden_arcanus:soul')
        .mobOutput(SummoningOutput.mob('thermal:basalz').count(4).offset(0, 3, 0).spread(4, 0, 4))
        .input('minecraft:obsidian')
