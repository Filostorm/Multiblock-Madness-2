...
onEvent('recipes', (event) => {
    ...
    //Kiln Rubber
    event.recipes
        .immersiveengineeringAlloy('3x thermal:cured_rubber', '2x thermal:rubber', [
            '#forge:dusts/sulfur',
            '#forge:gems/sulfur'
        ])
        .id(`mbm2:kiln/curing_rubber`);
    ...
    event
        .shaped('thermal:device_tree_extractor', ['ABA', 'CDC', 'AEA'], {
            A: '#minecraft:planks',
    ...
    event
        .shaped('thermal:machine_furnace', [' B ', 'CDC', 'EFE'], {
    ...
    event
        .shaped('thermal:machine_crafter', [' B ', 'CDC', 'EFE'], {
    ...
    event
        .shaped('thermal:machine_chiller', [' B ', 'CDC', 'EFE'], {
            A: Item.empty,
    ...
    event
        .shaped('thermal:machine_crucible', [' B ', 'CDC', 'EFE'], {
            B: '#forge:glass',
    ...
    event
        .shaped('thermal:machine_press', [' B ', 'CDC', 'EFE'], {
    ...
    event
        .shaped('thermal:machine_crystallizer', ['ABA', 'CDC', 'EFE'], {
    ...
    //Silver Coil
    event
        .shaped('kubejs:silver_coil', ['A  ', ' C ', '  A'], {
    ...
    event
        .shaped('thermal:upgrade_augment_1', ['ICI', 'RGR', 'ICI'], {
    ...
    // Latex
    event.recipes.thermal.chiller('thermal:rubber', [
        Fluid.of('industrialforegoing:latex', 250),
        'thermal:chiller_ball_cast'
    ]);
    event.recipes.thermal.chiller('thermal:rubber_block', [
        Fluid.of('industrialforegoing:latex', 1000)
    ]);

    //Magma
    event.recipes.thermal
        .crucible(Fluid.of('tconstruct:magma', 250), 'minecraft:magma_cream')
        .id(`mbm2:magma_from_ball`);
    ...
    //Hive Hopper recipe
    event
        .shaped('thermal:device_hive_extractor', [' A ', 'BCB', ' D '], {
            A: 'littlelogistics:fluid_hopper',
            B: 'create:cogwheel',
            C: 'create:andesite_casing',
            D: 'engineersdecor:factory_hopper'
        })
        .id(`mbm2:hive_hopper`);
    ...
    global.powahEnergizing(
        event,
        [Item.of('thermal:rf_coil').toJson()],
        Item.of('kubejs:charged_coil'),
        25000,
        'mbm2:charged_coil'
    );
    ...
    event
        .shaped('thermal:device_rock_gen', ['ABA', 'CDC', 'AEA'], {
        ...
        .id(`mbm2:device_rock_gen`);

    //tinker_bench
    event.remove({ output: 'thermal:tinker_bench' });
    event
        .shaped('thermal:tinker_bench', ['ABA', 'CDC', 'CEC'], {
            A: 'kubejs:iron_plating',
            B: 'minecraft:crafting_table',
            C: 'immersiveengineering:treated_wood_horizontal',
            D: 'kubejs:bronze_frame',
            E: 'thermal:rf_coil'
        })
        .id(`mbm2:tinker_bench`);

    //charge_bench
    event.remove({ output: 'thermal:charge_bench' });
    event
        .shaped('thermal:charge_bench', ['ABA', 'CDC', 'ECE'], {
            ...
            E: 'thermal:lead_plate'
        })
        .id(`mbm2:charge_bench`);

    //flux_drill
    event.remove({ output: 'thermal:flux_drill' });
    event
        .shaped('thermal:flux_drill', [' A ', 'BCB', ' D '], {
            A: 'thermal:drill_head',
            B: 'kubejs:tier_1_mechanical_alloy_interlocking_component',
            C: 'thermal:ruby',
            D: 'kubejs:charged_coil'
        })
        .id(`mbm2:flux_drill`);
    //flux_magnet
    event.remove({ output: 'thermal:flux_magnet' });
    event
        .shaped('thermal:flux_magnet', ['A A', 'BCB', 'BBB'], {
            A: 'create:polished_rose_quartz',
            B: 'kubejs:tier_1_structural_alloy_plate',
            C: 'kubejs:charged_coil'
        })
        .id(`mbm2:flux_magnet`);
    //flux_saw
    ...
    event
        .shaped('thermal:flux_saw', [' A ', 'BCB', ' D '], {
            A: 'thermal:saw_blade',
            B: 'kubejs:tier_1_mechanical_alloy_interlocking_component',
            C: 'thermal:ruby',
            D: 'kubejs:charged_coil'
    ...
    event
        .shaped('thermal:flux_capacitor', ['ABA', 'CDC', ' E '], {
            A: 'thermal:lead_plate',
            B: 'thermal:ruby',
            C: 'kubejs:energetic_alloy_bolt',
            D: 'kubejs:small_battery_empty',
            E: 'kubejs:charged_coil'
        })
        .id(`mbm2:flux_capacitor`);

    //saw_blade
    event.remove({ output: 'thermal:saw_blade' });
    event
        .shaped('thermal:saw_blade', ['AA ', 'ABA', ' AA'], {
            A: 'thermal:iron_plate',
            B: 'kubejs:bronze_plating'
        })
        .id(`mbm2:saw_blade`);
    //drill_head
    event.remove({ output: 'thermal:drill_head' });
    event
        .shaped('thermal:drill_head', [' A ', 'ABA', 'AAA'], {
            A: 'thermal:iron_plate',
            B: 'kubejs:bronze_plating'
        })
        .id(`mbm2:drill_head`);
    ...
    event
        .shaped('thermal:dynamo_compression', [' A ', 'BCB', 'DED'], {
            A: 'thermal:rf_coil',
            B: 'kubejs:dielectric_alloy_ingot',
            C: 'thermal:bronze_gear',
            D: 'thermal:bronze_ingot',
            E: 'kubejs:dynamo_frame'
        })
        .id('mbm2:compression_dynamo');
    event.remove({ output: 'thermal:dynamo_numismatic' });
    event
        .shaped('thermal:dynamo_numismatic', [' A ', 'BCB', 'DED'], {
            A: 'thermal:rf_coil',
            B: 'kubejs:dielectric_alloy_ingot',
            C: 'thermal:tin_gear',
        ...
        .id('mbm2:numismatic_dynamo');
    event.remove({ output: 'thermal:dynamo_lapidary' });
    event
        .shaped('thermal:dynamo_lapidary', [' A ', 'BCB', 'DED'], {
            A: 'thermal:rf_coil',
            B: 'kubejs:dielectric_alloy_ingot',
            C: 'thermal:gold_gear',
        ...
        .id('mbm2:lapidary_dynamo');
    event.remove({ output: 'thermal:dynamo_disenchantment' });
    event
        .shaped('thermal:dynamo_disenchantment', [' A ', 'BCB', 'DED'], {
            A: 'thermal:rf_coil',
            B: 'kubejs:dielectric_alloy_ingot',
        ...
        .id('mbm2:disenchantment_dynamo');
    event.remove({ output: 'thermal:dynamo_gourmand' });
    event
        .shaped('thermal:dynamo_gourmand', [' A ', 'BCB', 'DED'], {
            A: 'thermal:rf_coil',
            B: 'kubejs:dielectric_alloy_ingot',
    ...
    global.compactCrafting(
        ...
        'kubejs:dynamo_frame',
        2,
        'kubejs:tier_1_mechanical_alloy_gear',
        3,
        [
            {
                type: 'compactcrafting:mixed',
    ...
    event
        .shaped('kubejs:dynamo_frame', ['ABA', 'CBC', 'DCD'], {
            A: 'thermal:obsidian_glass',
            B: 'extendedcrafting:redstone_ingot_block',
            C: 'kubejs:tier_1_structural_alloy_scaffolding',
            D: 'kubejs:tier_1_structural_alloy_casing'
        })
        .id('mbm2:crafting/dynamo_frame');

    //Induction Smelter
    event.remove({ output: 'thermal:machine_smelter' });
    event
        .shaped('thermal:machine_smelter', ['ABA', 'CDC', 'AEA'], {
            A: 'mekanism:induction_casing',
            B: 'engineersdecor:small_mineral_smelter',
            C: 'kubejs:tier_2_electrical_alloy_wire_coil',
            D: 'thermal:machine_frame',
            E: 'kubejs:charged_coil'
        })
        .id('mbm2:crafting/induction_smelter');
    ...
    event.recipes
        .createMixing(
            ...
            [
                Fluid.of('pneumaticcraft:memory_essence', 1000),
                '2x ars_nouveau:air_essence',
                '4x minecraft:glowstone_dust'
            ]
        )
        .id(`mbm2:mixing/artifical_blitz`);
    event.recipes
        .createMixing(
        ...
        .id(`mbm2:mixing/artifical_blizz`);
    event.recipes
        .createMixing(
        ...
        .id(`mbm2:mixing/artifical_basalz`);
});
