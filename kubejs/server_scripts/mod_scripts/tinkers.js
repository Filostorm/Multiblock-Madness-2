onEvent('recipes', (event) => {
    ...
    event
        .shapeless(Item.of('tconstruct:puny_smelting', '{mantle:{book:{current_page:""}}}'), [
            'minecraft:book',
            'kubejs:unfired_clay_brick'
        ])
        .id(`mbm2:puny_smelting`);
    ...
    //Seared Tank recipes
    event.replaceInput(
        { output: '#tconstruct:scorched_tanks' },
        'quartz',
    ...
    //Double smelting recipe
    event.replaceInput(
        { id: 'tconstruct:smeltery/melting/scorched/grout' },
    ...
    event.shaped('tconstruct:smeltery_controller', ['ACA', 'CDC', 'ACA'], {
    ...
    event
        .shaped('tconstruct:seared_faucet', ['A A', ' A '], {
            A: 'tconstruct:seared_brick'
        })
    ...
    event
        .shaped('tconstruct:scorched_faucet', ['A A', ' A '], {
    ...
    event.shaped('tconstruct:foundry_controller', ['PCP', 'GBF', 'PCP'], {
    ...
    //soulsteel fixes
    event
        .shapeless('tconstruct:soulsteel_block', [
        ...
        .id('mbm2:soulsteel_ingot_to_block');
    event
        .shapeless('tconstruct:soulsteel_ingot', [
        ...
        .id('mbm2:soulsteel_nugget_to_ingot');
    event
        .shapeless('9x tconstruct:soulsteel_nugget', ['tconstruct:soulsteel_ingot'])
        .id('mbm2:soulsteel_ingot_to_nugget');
    event
        .shapeless('9x tconstruct:soulsteel_ingot', ['tconstruct:soulsteel_block'])
        .id('mbm2:soulsteel_block_to_ingot');
    ...
    global.thermalChilling(
        ...
        4000,
        `thermal:machines/chiller/chiller_soulsteel`
    );
});
