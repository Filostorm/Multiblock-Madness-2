onEvent('recipes', (event) => {
    // Sludge Sifter
    event
        .shaped('mbm2:sludge_sifter', ['ABA', 'CDC', 'EFE'], {
            A: 'create:cogwheel',
    ...
    // Sorter Mk1
    event
        .shaped('mbm2:sorter_mk1', ['QWQ', 'RLR', 'QWQ'], {
            W: '#forge:wires/zinc',
            R: '#forge:rods/brass',
    ...
    // Air Collector Mk1
    event
        .shaped('mbm2:air_collector_mk1', ['CPC', 'OHO', 'CGC'], {
    ...
    // Flotation
    event
        .shaped('mbm2:flotation', ['PAP', 'ECW', 'PTP'], {
            C: 'kubejs:tier1_casing',
    ...
    // Mixer
    event
        .shaped('mbm2:mixer_mk1', ['PMP', 'GCA', 'PIP'], {
            C: 'kubejs:tier1_casing',
    ...
    // sorter_mk2
    event
        .shaped('mbm2:sorter_mk2', ['PTP', 'MCA', 'PGP'], {
            C: 'kubejs:tier1_casing',
    ...
    // leaching_vat
    event
        .shaped('mbm2:leaching_vat', ['PBP', 'TCA', 'PGP'], {
    ...
    // Deposition Chamber
    event
        .shaped('mbm2:deposition_chamber', ['ABA', 'CDC', 'AEA'], {
            A: 'mekanism:hdpe_sheet',
            B: 'mekanism:advanced_control_circuit',
            C: '#forge:gears/stainless_steel',
            D: 'kubejs:tier2_casing',
            E: 'industrialforegoing:pink_slime_ingot'
        })
        .id('mbm2:deposition_chamber');

    // cast_press
    event
        .shaped('mbm2:cast_press', ['ABA', 'CDC', 'AEA'], {
            A: 'kubejs:steel_plate',
            B: 'immersiveengineering:component_electronic_adv',
            C: 'tconstruct:scorched_bricks',
            D: 'kubejs:tier1_casing',
            E: 'kubejs:titanium_gear'
        })
        .id('mbm2:cast_press');

    // casting_machine
    event
        .shaped('mbm2:casting_machine', ['ABA', 'CDC', 'EEE'], {
            A: 'industrialforegoing:pink_slime_ingot',
            B: 'immersiveengineering:component_electronic_adv',
            C: 'kubejs:industrial_alloy_component',
            D: 'kubejs:tier2_casing',
            E: 'kubejs:osmium_gear'
        })
        .id('mbm2:casting_machine');

    // fluid_centrifuge_mk1
    event
        .shaped('mbm2:fluid_centrifuge_mk1', ['ABA', 'CDC', 'EFE'], {
            ...
            E: 'kubejs:tier_1_mechanical_alloy_rod',
            F: 'thermal:fluid_cell_frame'
        })
        .id('mbm2:fluid_centrifuge_mk1');

    // mana_compressor
    event
        .shaped('mbm2:mana_compressor', ['AAA', 'BCB', 'DED'], {
            A: 'kubejs:platinum_plating',
            B: 'botania:rune_mana',
            C: 'kubejs:high_pressure_casing',
            D: 'pneumaticcraft:advanced_pressure_tube',
            E: 'kubejs:tier_1_mechanical_alloy_interlocking_component'
        })
        .id('mbm2:mana_compressor');

    // chemical_reactor
    event
        .shaped('mbm2:chemical_reactor', ['ABA', 'CDC', 'ECE'], {
            A: 'thermal:obsidian_glass',
            B: 'pneumaticcraft:printed_circuit_board',
            C: 'kubejs:white_alloy_plate',
            D: 'kubejs:tier1_casing',
            E: 'powah:capacitor_niotic'
        })
        .id('mbm2:chemical_reactor');

    // heater
    event
        .shaped('mbm2:heater', ['AAA', 'BCB', 'DED'], {
            A: 'beyond_earth:compressed_desh',
            B: 'kubejs:tier_2_electrical_alloy_wire_coil',
            C: 'mekanism:resistive_heater',
            D: 'kubejs:plastic_scaffolding',
            E: 'kubejs:tier1_casing'
        })
        .id('mbm2:heater');

    // vaccum_chamber
    event
        .shaped('mbm2:vaccum_chamber', ['ABA', 'CDC', 'EFE'], {
            A: 'pneumaticcraft:vacuum_pump',
            B: 'pneumaticcraft:printed_circuit_board',
            C: 'kubejs:exoskeleton_composit_reinforced_plating',
            D: 'kubejs:high_pressure_casing',
            E: 'kubejs:desh_coil',
            F: 'kubejs:stainless_steel_gear'
        })
        .id('mbm2:vaccum_chamber');

    // sintering_oven
    event
        .shaped('mbm2:sintering_oven', ['ABA', 'CDC', 'EFE'], {
            A: 'kubejs:tier_2_structural_alloy_bolt',
            B: 'immersiveengineering:component_electronic_adv',
            C: 'immersiveengineering:blastbrick_reinforced',
            D: 'pneumaticcraft:advanced_air_compressor',
            E: 'kubejs:compressed_steel_component',
            F: 'kubejs:tier2_casing'
        })
        .id('mbm2:sintering_oven');

    // mechanical_crafter
    event
        .shaped('mbm2:mechanical_crafter', ['ABA', 'CDC', 'AEA'], {
            A: 'kubejs:tier_2_structural_alloy_plating',
            B: 'pneumaticcraft:printed_circuit_board',
            C: 'kubejs:tier_2_mechanical_alloy_robot_arm',
            D: 'mekanism:formulaic_assemblicator',
            E: 'kubejs:tier2_casing'
        })
        .id('mbm2:mechanical_crafter');

    // energy_converter
    event
        .shaped('mbm2:energy_converter', ['ABA', 'CDC', 'AEA'], {
            A: 'kubejs:tier_1_electrical_alloy_wire_coil',
            B: 'pneumaticcraft:printed_circuit_board',
            C: 'immersiveengineering:coil_hv',
            D: 'thermal:charge_bench',
            E: 'kubejs:tier2_casing'
        })
        .id('mbm2:energy_converter');

    // fusion_reactor
    event
        .shaped('mbm2:fusion_reactor', ['ABA', 'CDC', 'EAE'], {
            A: 'kubejs:ai_chip',
            B: 'mekanism:ultimate_tier_installer',
            C: 'alchemistry:fusion_core',
            D: 'kubejs:machine_casing_fusion_glass',
            E: '#forge:reinforced_platings/adamantine_alloy'
        })
        .id('mbm2:fusion_reactor');

    //Elemental Stabilizer
    event.shaped('mbm2:elemental_stabilizer', ['ABA', 'CDE', 'AFA'], {
        A: 'kubejs:rune_ingot',
        B: 'botania:dirt_rod',
        C: 'botania:water_rod',
        D: 'kubejs:transmuted_casing',
        E: 'botania:tornado_rod',
        F: 'botania:fire_rod'
    });

    //cENTREFUGE
    event
        .shaped('mbm2:centrifuge_mk2', ['ABA', 'CDC', 'AEA'], {
            A: 'kubejs:osmium_plating',
            B: 'pneumaticcraft:printed_circuit_board',
            C: 'kubejs:tier_2_mechanical_alloy_interlocking_component',
            D: 'thermal:machine_centrifuge',
            E: 'kubejs:tier2_casing'
        })
        .id('mbm2:centrifuge_mk2');
    //crystal_chamber
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['ABCBA', 'ADEDA', 'CFGFC', 'AHIJA', 'AACAA'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['AAAAAAA', 'ABBBBBA', 'ABCDCBA', 'AEFGFEA', 'AEHIHEA', 'AEEEEEA', 'AAAAAAA'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['ABCBA', 'BDEDB', 'DFGFD', 'HIJIH', 'HHIHH'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['AABAA', 'ACDCA', 'ECFCE', 'GCDCG', 'GGHGG'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['AABAA', 'CDEDC', 'FGHGF', 'CDIDC', 'CCCCC'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['AABAA', 'ACDCA', 'EDFDE', 'ACDCA', 'AAGAA'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['ABBCBBA', 'BDEEEDB', 'BEFGFEB', 'HEIJIEK', 'BEFGFEB', 'BDEEEDB', 'ABBLBBA'],
            key: {
                A: {
    ...
    event
        .custom({
            type: 'extendedcrafting:shaped_table',
            pattern: ['ABCBA', 'BCDCB', 'CDEDC', 'BCDCB', 'ABCBA'],
            key: {
                A: {
