...
onEvent('recipes', event => {
    ...
    {output:'mna:decoration/transmuted_silver_block',items:['#forge:storage_blocks/pewter',Item.of('2x mna:manaweave_bottle', '{pattern:"mna:manaweave_patterns/square"}')]},
    ...
    {output:"mna:transmuted_silver",items:['#forge:ingots/pewter',Item.of('mna:manaweave_bottle', '{pattern:"mna:manaweave_patterns/square"}')]},
