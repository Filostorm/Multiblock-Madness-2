...
onEvent('recipes', (event) => {
    ...
    //First Steel
    event.recipes
        .createMixing(`kubejs:carbon_covered_iron`, [
            `#forge:ingots/iron`,
            '#forge:dusts/coal_coke'
        ])
        .heated()
        .id(`mbm2:carbon_covered_iron`);
    global.tinkersMelting(
        event,
        'kubejs:molten_slag',
        50,
        'tconstruct:molten_steel',
        90,
        'kubejs:carbon_covered_iron',
        1200,
        100,
        `mbm2:smeltery/melting/metal/first_steel`
    );

    event.recipes.thermal
        .smelter(
            [`#forge:ingots/steel`, Item.of('thermal:slag').withChance(0.5)],
            ['#forge:ingots/iron', '#minecraft:coals']
        )
        .id(`mbm2:thermal/steel`);
    event.recipes
        ...
        .id(`mbm2:arc_furnace/steel`);

    event.recipes.thermal
        .smelter(
            [`2x #forge:ingots/steel`, Item.of('thermal:slag').withChance(0.5)],
            ['2x #forge:ingots/iron', '#forge:coal_coke']
        )
        .id(`mbm2:thermal/coke_steel`);
    event.recipes
        .immersiveengineeringArcFurnace(
            Item.of('2x #forge:ingots/steel'),
            '2x #forge:ingots/iron',
            '#forge:coal_coke',
            'thermal:slag'
        )
        .id(`mbm2:arc_furnace/coke_steel`);
    ...
    // Damascus Steel
    event.recipes
        .createCutting('kubejs:steel_scraps', ['#forge:ingots/steel'])
        .processingTime(400)
        .id(`mbm2:cutting/steel_scraps`);
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                // input.
                event.recipes.createFilling('kubejs:partially_folded_damascus_steel', [
                    'kubejs:partially_folded_damascus_steel',
                    Fluid.of('lava', 50)
                ]),
                event.recipes.createPressing('kubejs:partially_folded_damascus_steel', [
                    'kubejs:partially_folded_damascus_steel'
                ]),
                event.recipes
                    .createCutting('kubejs:partially_folded_damascus_steel', [
                        'kubejs:partially_folded_damascus_steel'
                    ])
                    .processingTime(50)
        ...
        .transitionalItem('kubejs:partially_folded_damascus_steel')
        .loops(20)
        .id(`mbm2:damascus_steel_ingot`);
...
*/
    ...
    event
        .shaped('4x kubejs:industrial_alloy_ingot', ['AIQ', 'IBI', 'QIA'], {
    ...
    event
        .shaped('2x kubejs:industrial_alloy_ingot', ['AIQ', 'IBI', 'QIA'], {
    ...
    global.powahEnergizing(
        event,
        [Item.of('#forge:dusts/glowstone').toJson(), Item.of('#forge:dusts/redstone').toJson()],
        Item.of('kubejs:energetic_blend'),
        15000,
        'mbm2:powah/energetic_blend'
    );

    //Energetic Alloy
    event.recipes.tconstruct
        .casting_table('kubejs:energetic_alloy_ingot', 'tconstruct:molten_electrum', 90)
        .cast('kubejs:energetic_blend')
        .consumeCast()
        .coolingTime(100)
        .id(`mbm2:energetic_alloy_ingot`);

    //Soul Steel (tinkers)
    global.tinkersAlloying(
        event,
        'tconstruct:molten_soulsteel',
        90,
        [
            { name: 'kubejs:molten_nethersteel', amount: 90 },
            { name: 'kubejs:liquid_smoke', amount: 100 },
            { name: 'tconstruct:liquid_soul', amount: 500 }
        ],
        1000,
        `mbm2:smeltery/alloys/molten_soulsteel`
    );

    ///////////// Brick Chain /////////////
    //Clay Bricks
    event.recipes
        .createPressing('kubejs:unfired_clay_brick', 'minecraft:clay_ball')
        .id(`mbm2:pressing/unfired_clay_brick`);
    //Brik
    ...
    //Sandy Bricks
    event.recipes
        .createMixing([`kubejs:sandy_brick`], ['kubejs:unfired_clay_brick', 'sand'])
        .id('mbm2:mixing/sandy_brick');

    //Sturdy Bricks
    event.recipes
        .createMixing([`kubejs:sturdy_brick`], ['kubejs:sandy_brick', 'gravel'])
        .id('mbm2:mixing/sturdy_brick');
    //Seared Brick
    event
        .smelting('tconstruct:seared_brick', 'kubejs:sturdy_brick')
        .id(`mbm2:smelting/seared_brick`);
    //Coke Oven Brick
    event
        .blasting('kubejs:coke_oven_brick', 'tconstruct:seared_brick')
        .id(`mbm2:blasting/coke_oven_brick`);

    //Tough Bricks
    event.recipes
        .createMixing('kubejs:tough_brick', [
            Fluid.of('kubejs:molten_slag', 125),
            'create:cinder_flour',
            'kubejs:sturdy_brick'
        ])
        .id(`mbm2:mixing/tough_brick`);
    ...
    //Scorched Bricks
    event
        .smelting('tconstruct:scorched_brick', 'kubejs:tough_brick')
        .id(`mbm2:smelting/scorched_brick`);
    //Blast Bricks
    event
        .blasting('kubejs:blast_brick', 'tconstruct:scorched_brick')
        .id(`mbm2:blasting/blast_brick`);

    //Heated Bricks
    event.recipes
        .createFilling('kubejs:heated_brick', [
            Fluid.of('tconstruct:magma', 250),
            'kubejs:tough_brick'
        ])
        .id('mbm2:filling/heated_brick');

    //Spirited Bricks
    event.recipes
        .createCompacting('kubejs:spirited_brick', ['kubejs:heated_brick', 'spirit:soul_powder'])
        .superheated()
        .id(`mbm2:compacting/spirited_brick`);

    //Reactive Blend
    event
        .shaped('kubejs:reactive_blend', ['RL', 'Q '], {
    ...
    event.recipes
        .createMixing(
            [`2x kubejs:reactive_blend`],
            ['#forge:dusts/redstone', '#forge:dusts/lapis', '#forge:dusts/quartz']
        )
        .id('mbm2:mixing/reactive_blend');
    ...
    global.tinkersAlloying(
        event,
        'kubejs:molten_hardened_glass',
        250,
        [
            { name: 'tconstruct:molten_quartz', amount: 50 },
            { name: 'tconstruct:molten_glass', amount: 250 },
            { name: 'tconstruct:molten_obsidian', amount: 250 }
        ],
        1000,
        `mbm2:smeltery/alloys/molten_hardened_glass`
    );
    event.recipes.tconstruct
        .casting_basin('thermal:obsidian_glass', 'kubejs:molten_hardened_glass', 1000)
        .noCast()
        .coolingTime(250)
        .id(`mbm2:casting/hardened_glass`);
    ...
    global.mekanismInfusionConversion(
        event,
        Item.of('hostilenetworks:empty_prediction'),
        'kubejs:matrix',
        10,
        'mbm2:infuse/matrix'
    );
    ...
    global.mekanismInfusionConversion(
        event,
        Item.of('chemlib:chitin'),
        'kubejs:chitin',
        10,
        'mbm2:infuse/chitin_from_chitin'
    );
    global.mekanismInfusionConversion(
        event,
        ...
        'kubejs:chitin',
        100,
        'mbm2:infuse/chitin_from_chitin_dust'
    );
    ...
    event.recipes
        .mekanismMetallurgicInfusing(
            'kubejs:exoskeleton_composit_ingot',
            Item.of('#forge:ingots/ostrum'),
            { infuse_type: 'kubejs:chitin', amount: 100 }
        )
        .id(`mbm2:exoskeleton_composit_ingot`);
    ...
    event.recipes.thermal.crucible(Fluid.of('kubejs:molten_slag', 250), [
        'thermal:slag',
        'kubejs:slag_dust'
    ]);
    ...
    event.recipes
        .createMixing([Fluid.of('kubejs:molten_slag', 250)], ['kubejs:slag_dust'])
        .heated()
        .id(`mbm2:mixing/slag`);

    //Luminite
    event.recipes.thermal.crucible(Fluid.of('kubejs:molten_luminite', 250), [
        'kubejs:luminite',
        'kubejs:luminite_dust'
    ]);
    ...
    //Blazing Redstone
    event.recipes
        .createMixing('kubejs:blazing_redstone', [
            'minecraft:blaze_powder',
            '#forge:dusts/redstone'
        ])
        .id(`mbd2:create/mixing/blazing_redstone`);
    event.recipes.multiblocked
        .multiblock('mixer')
    ...
    event.recipes.thermal
        .crucible(Fluid.of(`kubejs:blazing_pyrotheum`, 250), `kubejs:pyrotheum_dust`)
        .id(`mbm2:crucible/pyrotheum`);
    global.tinkersMeltingPlain(
        event,
        'kubejs:blazing_pyrotheum',
        250,
        '#forge:dusts/pyrotheum',
        900,
        20,
        `mbm2:smeltery/melting/pyrotheum`
    );
    event.recipes.thermal
        .crucible(Fluid.of(`kubejs:gelid_cryotheum`, 250), `kubejs:cryotheum_dust`)
        .id(`mbm2:crucible/cryotheum`);
    event.recipes.thermal
        .crucible(Fluid.of(`kubejs:zephyrean_aerotheum`, 250), `kubejs:aerotheum_dust`)
        .id(`mbm2:crucible/aerotheum`);
    event.recipes.thermal
        .crucible(Fluid.of(`kubejs:tectonic_petrotheum`, 250), `kubejs:petrotheum_dust`)
        .id(`mbm2:crucible/petrotheum`);
    ...
    for (var tier in gemTiers) {
        event.recipes.multiblocked
            .multiblock('elemental_stabilizer')
    ...
    global.anyFilling(
        ...
        Fluid.of('kubejs:stable_elemental_fusion', 500)
    );
    ...
    event.recipes
        .createCrushing(
            [
                Item.of('kubejs:nether_shard').withChance(0.4),
                Item.of('kubejs:nether_shard_west').withChance(0.2),
                Item.of('kubejs:nether_shard_east').withChance(0.1),
                Item.of('kubejs:nether_shard_south').withChance(0.05)
            ],
            'nether_star'
        )
        .id(`mbm2:crushing/nether_star`);

    //Get Rotated
    global.botaniaPool(
        event,
        'kubejs:nether_shard_east',
        'kubejs:nether_shard',
        250,
        'botania:alchemy_catalyst',
        `mbm2:botania/alchemy_catalyst/nether_shard_east`
    );
    global.botaniaPool(
        event,
        'kubejs:nether_shard_south',
        'kubejs:nether_shard_east',
        250,
        'botania:alchemy_catalyst',
        `mbm2:botania/alchemy_catalyst/nether_shard_south`
    );
    global.botaniaPool(
        event,
        'kubejs:nether_shard_west',
        'kubejs:nether_shard_south',
        250,
        'botania:alchemy_catalyst',
        `mbm2:botania/alchemy_catalyst/nether_shard_west`
    );
    global.botaniaPool(
        event,
        'kubejs:nether_shard',
        ...
        250,
        'botania:alchemy_catalyst',
        `mbm2:botania/alchemy_catalyst/nether_shard`
    );

    //Elemental Star
    event.recipes
        .createMechanicalCrafting('kubejs:elemental_star', [' N ', 'WCE', ' S '], {
    ...
    event.recipes.multiblocked
        .multiblock('mixer')
        .inputItems(
            'kubejs:astral_fusion_fine_dust',
            'kubejs:adamantine_alloy_fine_dust',
            'kubejs:exoskeleton_composit_fine_dust',
            '2x kubejs:asteroid_dust_tier_3',
            'kubejs:einsteinium_dust'
        )
    ...
    //Ingot Mold
    event
        .shaped('kubejs:ingot_mold', ['   ', 'A A', 'AAA'], { A: 'thermal:iron_plate' })
        .id('mbm2:ingot_mold');
        ...
        event.recipes.multiblocked
            ...
            .predicate((recipe, recipeLogic) => {
                ...
                global.coilPos.forEach((pos) => {
                    let coilName = level
                        .getBlockState(controllerTe.getBlockPos().offset(pos.x, pos.y, pos.z))
                        .getBlock();
    ...
    event.recipes.thermal
        .centrifuge(
            [
                Item.of('minecraft:ender_pearl').withChance(0.5),
                Fluid.of('kubejs:liquid_ender_air', 500)
            ],
            Item.of('hostilenetworks:prediction', '{data_model:{id:"hostilenetworks:enderman"}}')
        )
        .id(`mbm2:centrifuge/enderman_data`);

    //Shadows
    event.recipes.thermal
        .refinery(
            [
                Item.of('minecraft:dragon_breath').withChance(0.5),
                Fluid.of('kubejs:liquid_shadows', 500)
            ],
            Fluid.of('kubejs:liquid_ender_air', 1000)
        )
        .id(`mbm2:refinery/liquid_ender_air`);
});
