...
*/
    global.ieSqueezer(
        event,
        Fluid.of('pneumaticcraft:memory_essence', 100),
        Item.of('create:experience_nugget'),
        6400,
        'mbm2:squeezer/experience'
    );

    event.shaped('4x kubejs:catalyst_empty', [' A ', 'BBB', ' A '], {
        A: 'thermal:iron_plate',
        B: 'minecraft:glass'
    });
    event.shaped('16x kubejs:catalyst_empty', [' A ', 'BBB', ' A '], {
        A: 'kubejs:steel_plate',
        B: 'minecraft:glass'
    });
    event.shaped('64x kubejs:catalyst_empty', [' A ', 'BBB', ' A '], {
        A: 'kubejs:stainless_steel_plate',
        B: 'minecraft:glass'
    });
    ...
    global.ieMixer(
        event,
        Fluid.of('kubejs:basic_catalyst_mixture', 250),
        { tag: 'forge:experience', amount: 250 },
        Item.of('kubejs:slag_dust'),
        4000,
        'mbm2:mixer/basic_catalyst_mixture_slag'
    );

    //Filling
    event.recipes
        .createFilling('kubejs:catalyst_basic', [
            Fluid.of('kubejs:basic_catalyst_mixture', fillingAmount),
            'kubejs:catalyst_empty'
        ])
        .id('mbm2:filling/catalyst_basic');
    global.ieBottling(
        event,
        [Item.of('kubejs:catalyst_basic').toJson()],
        Item.of('kubejs:catalyst_empty').toJson(),
        { tag: 'forge:basic_catalyst_mixture', amount: fillingAmount },
        'mbm2:ie/bottling/catalyst_basic'
    );
    event.recipes.thermal
        .bottler('kubejs:catalyst_basic', [
            'kubejs:catalyst_empty',
            Fluid.of('kubejs:basic_catalyst_mixture', fillingAmount)
        ])
        .id('mbm2:thermal/bottling/catalyst_basic');

    //////Crystal Catlyst//////
    global.ieMixer(
        event,
        Fluid.of('kubejs:crystal_catalyst_mixture', 1000),
        { tag: 'forge:experience', amount: 1000 },
        Item.of('apotheosis:gem_dust'),
        4000,
        'mbm2:mixer/crystal_catalyst_mixture'
    );
    global.ieMixer(
        event,
        Fluid.of('kubejs:crystal_catalyst_mixture', 250),
        { tag: 'forge:experience', amount: 250 },
        Item.of('kubejs:crystal_slag_dust'),
        4000,
        'mbm2:mixer/crystal_catalyst_mixture_slag'
    );

    //Filling
    event.recipes
        .createFilling('kubejs:catalyst_gem', [
            Fluid.of('kubejs:crystal_catalyst_mixture', fillingAmount),
            'kubejs:catalyst_empty'
        ])
        .id('mbm2:filling/catalyst_gem');
    global.ieBottling(
        event,
        [Item.of('kubejs:catalyst_gem').toJson()],
        Item.of('kubejs:catalyst_empty').toJson(),
        { tag: 'forge:crystal_catalyst_mixture', amount: fillingAmount },
        'mbm2:ie/bottling/catalyst_gem'
    );
    event.recipes.thermal
        .bottler('kubejs:catalyst_gem', [
            'kubejs:catalyst_empty',
            Fluid.of('kubejs:crystal_catalyst_mixture', fillingAmount)
        ])
        .id('mbm2:thermal/bottling/catalyst_gem');

    //////magic Catlyst//////
    global.ieMixer(
        event,
        Fluid.of('kubejs:magic_catalyst_mixture', 1000),
        { tag: 'forge:experience', amount: 1000 },
        Item.of('ars_nouveau:source_gem'),
        4000,
        'mbm2:mixer/magic_catalyst_mixture'
    );
    global.ieMixer(
        event,
        Fluid.of('kubejs:magic_catalyst_mixture', 500),
        { tag: 'forge:experience', amount: 1000 },
        Item.of('botania:mana_powder'),
        4000,
        'mbm2:mixer/magic_catalyst_mixture_slag'
    );

    //Filling
    event.recipes
        .createFilling('kubejs:catalyst_magic', [
            Fluid.of('kubejs:magic_catalyst_mixture', fillingAmount),
            'kubejs:catalyst_empty'
        ])
        .id('mbm2:filling/catalyst_magic');
    global.ieBottling(
        event,
        [Item.of('kubejs:catalyst_magic').toJson()],
        Item.of('kubejs:catalyst_empty').toJson(),
        { tag: 'forge:magic_catalyst_mixture', amount: fillingAmount },
        'mbm2:ie/bottling/catalyst_magic'
    );
    event.recipes.thermal
        .bottler('kubejs:catalyst_magic', [
            'kubejs:catalyst_empty',
            Fluid.of('kubejs:magic_catalyst_mixture', fillingAmount)
        ])
        .id('mbm2:thermal/bottling/catalyst_magic');
    ...
    global.newMaterialParts.forEach((item) => {
        ...
        if (item.ore) {
            ...
            if (Item.of(`#forge:ores/raw/${item.material}`) != null) {
                event
                    .shaped(Item.of(`#forge:ores/raw/${item.material}`), ['FF', 'FF'], {
                        F: Item.of(`#forge:ores/fragment/${item.material}`)
                    })
                    .id(`mbm2:${item.material}_fragment_merge`);
                event
                    .shapeless(`4x #forge:ores/fragment/${item.material}`, [
                        `#forge:ores/raw/${item.material}`
                    ])
                    .id(`mbm2:${item.material}_fragment_split`);
            }
            ...
            global.oreProcessingParts.forEach((part) => {
                if (
                    part.grade >= item.tier - 1 &&
                    Item.of(`#forge:ores/${part.name}/${item.material}`) != null
                ) {
            ...
            if (Item.of(`#forge:dusts/${item.material}`) != null) {
                ...
                if (Item.of(`#forge:ores/pure/${item.material}`) != null) {
                    ...
                    event.recipes
                        .createMilling(
                            [`#forge:dusts/${item.material}`],
                            [`#forge:ores/pure/${item.material}`]
                        )
                        .id(`mbm2:create/crushing/pure_${item.material}`);
                    event.recipes
                        .mekanismCrushing(
                            `#forge:dusts/${item.material}`,
                            `#forge:ores/pure/${item.material}`
                        )
                        .id(`mbm2:mekanism/crushing/pure_${item.material}`);
                }
                //Crush Smetable Ore
                if (refineProcessedOre != null) {
                    refineProcessedOre.forEach((part) => {
                        ...
                        event.recipes
                            .createMilling([`#forge:dusts/${item.material}`], part)
                            .id(`mbm2:create/crushing/${partName}`);
                        event.recipes
                            .mekanismCrushing(`#forge:dusts/${item.material}`, part)
                            .id(`mbm2:mekanism/crushing/${partName}`);
                    });
                }
                //Grit Washing
                if (Item.of(`#forge:ores/grit/${item.material}`) != null) {
                    event.recipes
                        .createSplashing(
                            [
                                Item.of(`#forge:dusts/${item.material}`).withChance(0.75),
                                Item.of('gravel').withChance(0.25)
                            ],
                            `#forge:ores/grit/${item.material}`
                        )
                        .id(`mbm2:washing/grit_${item.material}`);
                }
                //Fine Dust
            ...
            if (
                ...
                event.recipes
                    ...
                    .id(`mbm2:crushing/raw_${item.material}`);
                ...
                event.recipes
                    ...
                    .id(`mbm2:crushing/ore_${item.material}`);
                ...
                global.ieCrusher(
                    ...
                    {
                        count: 1,
                        base_ingredient: Item.of(`#forge:ores/chunk/${item.material}`).toJson()
                    }, //Output
                    [
                        { chance: 0.1, output: Item.of(byproduct('grit', 2)).toJson() },
                        { chance: 0.15, output: { item: 'immersiveengineering:slag_gravel' } }
                    ],
                    { tag: `forge:ores/crushed/${item.material}` }, //Input
                    6000,
                    `mbm2:immersiveengineering/crushing/crushed_${item.material}`
                );

                ///////////////////// ORE PROCESSING STEP 3 //////////////////
                //Water Filter
                event
                    .shaped('kubejs:water_filter', ['SWS', 'RWR', 'SWS'], {
                ...
                global.ieMixer(
                    event,
                    Fluid.of('kubejs:purified_water', 2000),
                    { tag: 'minecraft:water', amount: 2000 },
                    Item.of('kubejs:water_filter'),
                    4000,
                    'mbm2:filtering_water'
                );

                //Ore Flotation
                event.recipes.multiblocked
                    .multiblock('flotation')
                ...
                //Mesh
                event
                    .shaped('2x kubejs:mesh', ['WSW', 'SSS', 'WSW'], {
                        W: 'stick',
                        S: `string`
                    })
                    .id(`mbm2:mesh`);
                ...
                //Zinc Mesh
                event
                    .shaped('4x kubejs:zinc_mesh', [' M ', 'MZM', ' M '], {
                        M: 'kubejs:mesh',
                        Z: '#forge:dusts/zinc'
                    })
                    .id(`mbm2:zinc_mesh`);
                ...
                //Zinc Mesh
                event
                    .shaped('8x kubejs:zinc_mesh', ['MMM', 'MZM', 'MMM'], {
                        M: 'kubejs:mesh',
                ...
                global.mekanismMetallurgicInfusing(
                    event,
                    Item.of('kubejs:carbon_mesh'),
                    Item.of('kubejs:zinc_mesh'),
                    'mekanism:carbon',
                    10,
                    `mbm2:carbon_mesh`
                );
            ...
            if (item.ore && (item.type == 'base_metal' || item.type == 'rare_metal')) {
                ...
                event.recipes
                    .createSplashing(
                        [
                            `#forge:dusts/${item.material}`,
                            Item.of(`#forge:ores/grit/${item.material}`).withChance(0.25),
                            Item.of('gravel').withChance(0.25)
                        ],
                        `#mbm2:ore_part/refinable_tier_1/${item.material}` /*refinableOre(1) in tag form because washing is spechlae*/
                    )
                    .id(`mbm2:washing/${item.material}`);
                ...
                global.arsImbuement(
                    event,
                    pureOre,
                    global.refiningMultiplier[1],
                    `#mbm2:ore_part/refinable_tier_1/${item.material}`,
                    1000,
                    [
                        { item: { item: 'ars_nouveau:glyph_crush' } },
                        {
                            item: Item.of(
                                'elementalcraft:scroll',
                                '{elementalcraft:{spell:"elementalcraft:purification"}}'
                            ).toJson()
                        },
                        { item: { item: 'elementalcraft:pristine_earth_gem' } }
                    ],
                    `mbm2:purifing/${item.material}`
                );
                ...
                global.arsImbuement(
                    ...
                    pureOre,
                    1,
                    `#forge:ores/${global.oreRefiningParts[2].name}/${item.material}`,
                    250,
                    [
                        { item: { item: 'ars_nouveau:glyph_crush' } },
                        {
                    ...
                    `mbm2:purifing/${global.oreRefiningParts[2].name}_ore_${item.material}`
                );
                ...
                global.naturesauraAltar(
                    event,
                    `${global.refiningMultiplier[2]}x kubejs:${global.oreRefiningParts[2].name}_${item.material}`,
                    `#mbm2:ore_part/refinable_tier_2/${item.material}`,
                    'naturesaura:crushing_catalyst',
                    'overworld',
                    10000,
                    80,
                    `mbm2:${global.oreRefiningParts[2].name}/${item.material}`
                );
                //Chain recipe
                global.naturesauraAltar(
                    event,
                    `kubejs:${global.oreRefiningParts[2].name}_${item.material}`,
                    `kubejs:${global.oreRefiningParts[3].name}_${item.material}`,
                    'naturesaura:crushing_catalyst',
                    'overworld',
                    2000,
                    40,
                    `mbm2:chain_recipe/${global.oreRefiningParts[2].name}/${item.material}`
                );
                ...
                //Compressing
                event.recipes.multiblocked
                    .multiblock('mana_compressor')
                    .inputItem(refinableOre(3))
                    .inputItem(
                        Item.of('pneumaticcraft:air_canister', '{"pneumaticcraft:air":30000}')
                    )
                    .inputFluid(Fluid.of(`kubejs:liquid_mana`, 100))
                    .outputItem(
                        Item.of(
                            `${global.refiningMultiplier[3]}x #forge:ores/${global.oreRefiningParts[3].name}/${item.material}`
                        )
                    )
                ...
                event.recipes.multiblocked
                    ...
                    .inputItem(
                        Item.of(
                            `4x #forge:ores/${global.oreRefiningParts[4].name}/${item.material}`
                        )
                    )
                    .inputItem(
                        Item.of('pneumaticcraft:air_canister', '{"pneumaticcraft:air":30000}')
                    ...
                    .outputItem(
                        Item.of(
                            `4x #forge:ores/${global.oreRefiningParts[3].name}/${item.material}`
                        )
                    )
                    .outputItem('pneumaticcraft:air_canister')
                    .setPerTick(true)
                ...
                event
                    .custom({
                        ...
                        output: Item.of(
                            `#forge:ores/${global.oreRefiningParts[4].name}/${item.material}`,
                            global.refiningMultiplier[4]
                        )
                    })
                ...
                event
                    .custom({
                        ...
                        ingredients: [
                            Item.of(
                                `#forge:ores/${global.oreRefiningParts[5].name}/${item.material}`
                            ),
                    ...
                    if (tier <= 4) {
                        ...
                        event.recipes.multiblocked
                            ...
                            .predicate(
                                (recipe, recipeLogic) => {
                                    ...
                                    global.coilPos.forEach((pos) => {
                                        ...
                                        global.coilHeatValues.forEach((coil) => {
                                            if (
                                                Block.getBlock(`kubejs:${coil.name}_coil`).equals(
                                                    coilName
                                                )
                                            ) {
                                ...
                                Component.string(
                                    'Requires at least ' +
                                        nameUpper(global.coilHeatValues[tier - 4].name) +
                                        ' Coils'
                                )
                            );
                    }
                ...
                if (item.tier <= 1) {
                    ...
                    event
                        .smelting(`#forge:ingots/${item.material}`, smeltProcessedOre)
                        .xp(0.5)
                        .id(`mbm2:smelting/t1_ore_part_${item.material}`);
                    event
                        .blasting(`#forge:ingots/${item.material}`, smeltProcessedOre)
                        .xp(1.0)
                        .id(`mbm2:blasting/t1_ore_part_${item.material}`);
                    event
                        .smelting(`#forge:ingots/${item.material}`, smeltRefinedOre)
                        .xp(0.5)
                        .id(`mbm2:smelting/ore_refined_part_${item.material}`);
                    event
                        .blasting(`#forge:ingots/${item.material}`, smeltRefinedOre)
                        .xp(1.0)
                        .id(`mbm2:blasting/ore_refined_part_${item.material}`);

                    event
                        .smelting(
                            `2x #forge:nuggets/${item.material}`,
                            `#forge:ores/fragment/${item.material}`
                        )
                        .xp(0.5)
                        .id(`mbm2:smelting/fragment_${item.material}`);
                    event
                        .blasting(
                            `2x #forge:nuggets/${item.material}`,
                            `#forge:ores/fragment/${item.material}`
                    ...
                    if (item.fluid_id != null) {
                        smeltProcessedOre.forEach((part) => {
                            ...
                            global.tinkersOreMelting(
                                ...
                                1000,
                                150,
                                `mbm2:foundry/melting/${part.split(':')[1]}`
                            );
                        });
                        smeltRefinedOre.forEach((part) => {
                            global.tinkersMeltingPlain(
                                event,
                                item.fluid_id,
                                90,
                                Ingredient.of(part).toJson(),
                                900,
                                75,
                                `mbm2:smeltery/melting/${part.split(':')[1]}`
                            );
                        });
                    }
                    ...
                    event.recipes
                        .immersiveengineeringArcFurnace(
                            Item.of(`#forge:ingots/${item.material}`),
                            smeltProcessedOre
                        )
                        .id(`mbm2:arc_furnace/${item.material}_t1_ore_part`);
                ...
                if (item.tier == 2) {
                    event.remove({
                        id: `tconstruct:smeltery/melting/metal/${item.material}/ingot`
                    });
                    if (item.fluid_id != null) {
                        smeltProcessedOre.forEach((part) => {
                            //Foundry Processing for ores
                        ...
                        global.tinkersMeltingPlain(
                            ...
                            item.fluid_id,
                            90,
                            Ingredient.of(`#forge:ingots/${item.material}`).toJson(),
                            1000,
                            125,
                            `mbm2:smeltery/melting/metal/${item.material}/ingot`
                        );
                    } else {
                        console.log(
                            `KJS-ERROR: ${item.material} needs a fluid_id in Master Material List`
                        );
                    }
                    //Retro Arcing
                    event.recipes
                        ...
                        .id(`mbm2:arc_furnace/${item.material}_t2_ore_part`);
                ...
                if (item.tier == 3) {
                    event.recipes
                        ...
                        .id(`mbm2:arc_furnace/${item.material}_t3_ore_part`);
                ...
                if (item.tier <= 3) {
                    event.recipes
                        ...
                        .id(`mbm2:arc_furnace/${item.material}_ore_refined_part`);
                }
            ...
            if (item.type == 'compound_ore') {
                ...
                if (Item.of(`#forge:ingots/${item.components[0]}`) != null) {
                    event
                        .smelting(`#forge:ingots/${item.components[0]}`, [
                            `#forge:raw_materials/${item.material}`,
                            `#forge:dusts/${item.material}`,
                            `#forge:ores/grit/${item.material}`
                        ])
                        .id(`mbm2:smelting/raw_${item.material}`);
                    event
                        .blasting(`#forge:ingots/${item.components[0]}`, [
                            `#forge:raw_materials/${item.material}`,
                            `#forge:dusts/${item.material}`,
                            `#forge:ores/grit/${item.material}`
                        ])
                        .id(`mbm2:blasting/raw_${item.material}`);

                    event
                        .smelting(
                            `2x #forge:nuggets/${item.components[0]}`,
                            `#forge:ores/fragment/${item.material}`
                        )
                        .xp(0.5)
                        .id(`mbm2:smelting/fragment_${item.material}`);
                    ...
                    event.smelting(`2x #forge:dusts/${item.components[0]}`, [
                        `#forge:raw_materials/${item.material}`,
                        `#forge:dusts/${item.material}`
                    ]);
                    event.blasting(`2x #forge:dusts/${item.components[0]}`, [
                        `#forge:raw_materials/${item.material}`,
                        `#forge:dusts/${item.material}`
                    ]);
                }
                ...
                event.recipes.multiblocked
                    ...
                    .inputStress(64)
                    .outputItem(`4x #forge:ores/chunk/${item.components[0]}`)
                ...
                event.recipes.multiblocked
                    .multiblock('sorter_mk2')
                    .inputItem(`8x #forge:raw_materials/${item.material}`)
                    .outputItem(`4x #forge:raw_materials/${item.components[0]}`)
                    .outputItem(`3x #forge:raw_materials/${item.components[1]}`)
                    .outputItem('1x thermal:slag')
                    .setPerTick(true)
                    .inputFE(500)
                    .duration(200);
                ...
                event.recipes.multiblocked
                    .multiblock('sorter_mk2')
                    .inputItem(
                        `12x #forge:ores/${global.oreProcessingParts[1].name}/${item.material}`
                    )
                    .outputItem(
                        `5x #forge:ores/${global.oreProcessingParts[1].name}/${item.components[0]}`
                    )
                    .outputItem(
                        `4x #forge:ores/${global.oreProcessingParts[1].name}/${item.components[1]}`
                    )
                    .outputItem(
                        `2x #forge:ores/${global.oreProcessingParts[1].name}/${item.components[2]}`
                    )
                    .outputItem('1x thermal:slag')
                    .setPerTick(true)
                    .inputFE(500)
                ...
                event.recipes.multiblocked
                    .multiblock('sorter_mk2')
                    .inputItem(
                        `16x #forge:ores/${global.oreProcessingParts[2].name}/${item.material}`
                    )
                    .outputItem(
                        `6x #forge:ores/${global.oreProcessingParts[2].name}/${item.components[0]}`
                    )
                    .outputItem(
                        `5x #forge:ores/${global.oreProcessingParts[2].name}/${item.components[1]}`
                    )
                    .outputItem(
                        `3x #forge:ores/${global.oreProcessingParts[2].name}/${item.components[2]}`
                    )
                    .outputItem(
                        `1x #forge:ores/${global.oreProcessingParts[2].name}/${item.components[3]}`
                    )
                    .outputItem('1x thermal:slag')
                    .setPerTick(true)
                    .inputFE(500 * 4)
                ...
                event.recipes.multiblocked
                    .multiblock('sorter_mk2')
                    .inputItem(
                        `20x #forge:ores/${global.oreProcessingParts[3].name}/${item.material}`
                    )
                    .outputItem(
                        `6x #forge:ores/${global.oreProcessingParts[3].name}/${item.components[0]}`
                    )
                    .outputItem(
                        `5x #forge:ores/${global.oreProcessingParts[3].name}/${item.components[1]}`
                    )
                    .outputItem(
                        `4x #forge:ores/${global.oreProcessingParts[3].name}/${item.components[2]}`
                    )
                    .outputItem(
                        `3x #forge:ores/${global.oreProcessingParts[3].name}/${item.components[3]}`
                    )
                    .outputItem(
                        `1x #forge:ores/${global.oreProcessingParts[3].name}/${item.components[4]}`
                    )
                    .outputItem('1x thermal:slag')
                    .setPerTick(true)
                    .inputFE(500 * 4)
                ...
                event.recipes.multiblocked
                    .multiblock('sorter_mk2')
                    .inputItem(
                        `24x #forge:ores/${global.oreProcessingParts[4].name}/${item.material}`
                    )
                    .outputItem(
                        `7x #forge:ores/${global.oreProcessingParts[4].name}/${item.components[0]}`
                    )
                    .outputItem(
                        `6x #forge:ores/${global.oreProcessingParts[4].name}/${item.components[1]}`
                    )
                    .outputItem(
                        `4x #forge:ores/${global.oreProcessingParts[4].name}/${item.components[2]}`
                    )
                    .outputItem(
                        `3x #forge:ores/${global.oreProcessingParts[4].name}/${item.components[3]}`
                    )
                    .outputItem(
                        `2x #forge:ores/${global.oreProcessingParts[4].name}/${item.components[4]}`
                    )
                    .outputItem(
                        `1x #forge:ores/${global.oreProcessingParts[4].name}/${item.components[5]}`
                    )
                    .outputItem('1x thermal:slag')
                    .setPerTick(true)
                    .inputFE(500 * 16)
                ...
                event.recipes.multiblocked
                    .multiblock('sorter_mk2')
                    .inputItem(
                        `28x #forge:ores/${global.oreProcessingParts[5].name}/${item.material}`
                    )
                    .outputItem(
                        `7x #forge:ores/${global.oreProcessingParts[5].name}/${item.components[0]}`
                    )
                    .outputItem(
                        `6x #forge:ores/${global.oreProcessingParts[5].name}/${item.components[1]}`
                    )
                    .outputItem(
                        `5x #forge:ores/${global.oreProcessingParts[5].name}/${item.components[2]}`
                    )
                    .outputItem(
                        `4x #forge:ores/${global.oreProcessingParts[5].name}/${item.components[3]}`
                    )
                    .outputItem(
                        `2x #forge:ores/${global.oreProcessingParts[5].name}/${item.components[4]}`
                    )
                    .outputItem(
                        `2x #forge:ores/${global.oreProcessingParts[5].name}/${item.components[5]}`
                    )
                    .outputItem(
                        `1x #forge:ores/${global.oreProcessingParts[5].name}/${item.components[6]}`
                    )
                    .outputItem('1x thermal:slag')
                    .setPerTick(true)
                    .inputFE(500 * 64)
                ...
                event.recipes.multiblocked
                    .multiblock('sorter_mk2')
                    .inputItem(
                        `32x #forge:ores/${global.oreProcessingParts[6].name}/${item.material}`
                    )
                    .outputItem(
                        `7x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[0]}`
                    )
                    .outputItem(
                        `6x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[1]}`
                    )
                    .outputItem(
                        `5x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[2]}`
                    )
                    .outputItem(
                        `4x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[3]}`
                    )
                    .outputItem(
                        `3x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[4]}`
                    )
                    .outputItem(
                        `3x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[5]}`
                    )
                    .outputItem(
                        `2x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[6]}`
                    )
                    .outputItem(
                        `1x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[7]}`
                    )
                    .outputItem('1x thermal:slag')
                    .setPerTick(true)
                    .inputFE(500 * 256)
                ...
                oreMixer(
                    ...
                    3,
                    '#forge:ores/raw/zinc',
                    ['kubejs:catalyst_basic', '2x kubejs:raw_jimmium', '2x kubejs:raw_vincyte'],
                    2
                );
                oreMixer(
                    event,
                    3,
                    '#forge:ores/raw/lead',
                    ['kubejs:catalyst_basic', '2x kubejs:raw_densite', '2x kubejs:raw_potentium'],
                    2
                );
                oreMixer(
                    event,
                    3,
                    '#forge:ores/raw/silver',
                    ['kubejs:catalyst_basic', '2x kubejs:raw_potentium', '2x kubejs:raw_imortite'],
                    2
                );
                ...
                oreMixer(
                    event,
                    3,
                    '#forge:ores/raw/arcanite',
                    ['kubejs:catalyst_magic', '4x #forge:ores/compound/raw'],
                    2
                );
                ...
                oreMixer(
                    event,
                    2,
                    '#forge:ores/crushed/cobalt',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:crushed_vincyte',
                        '2x kubejs:crushed_imortite'
                    ],
                    4
                );
                oreMixer(
                    event,
                    2,
                    '#forge:ores/crushed/aluminum',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:crushed_densite',
                        '2x kubejs:crushed_kharaxium'
                    ],
                    4
                );
                oreMixer(
                    event,
                    2,
                    '#forge:ores/crushed/nickel',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:crushed_jimmium',
                        '2x kubejs:crushed_vincyte'
                    ],
                    4
                );
                oreMixer(
                    event,
                    2,
                    '#forge:ores/crushed/mithril',
                    [
                        'kubejs:catalyst_magic',
                        '2x kubejs:crushed_potentium',
                        '2x kubejs:crushed_densite'
                    ],
                    4
                );
                ...
                oreMixer(
                    event,
                    1,
                    '#forge:ores/chunk/magnesium',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:chunk_densite',
                        '2x kubejs:chunk_kharaxium'
                    ],
                    8
                );
                oreMixer(
                    event,
                    1,
                    '#forge:ores/chunk/titanium',
                    ['kubejs:catalyst_basic', '2x kubejs:chunk_vincyte', '2x kubejs:chunk_jimmium'],
                    8
                );
                oreMixer(
                    event,
                    1,
                    '#forge:ores/chunk/uranium',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:chunk_imortite',
                        '2x kubejs:chunk_densite'
                    ],
                    8
                );
                oreMixer(
                    event,
                    1,
                    '#forge:ores/chunk/aetherium',
                    [
                        'kubejs:catalyst_magic',
                        '2x kubejs:chunk_potentium',
                        '2x kubejs:chunk_vincyte'
                    ],
                    8
                );
                ...
                oreMixer(
                    event,
                    2,
                    '#forge:ores/lump/platinum',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:lump_kharaxium',
                        '2x kubejs:lump_imortite',
                        '2x kubejs:lump_vincyte'
                    ],
                    16
                );
                oreMixer(
                    event,
                    2,
                    '#forge:ores/lump/osmium',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:lump_densite',
                        '2x kubejs:lump_jimmium',
                        '2x kubejs:lump_potentium'
                    ],
                    16
                );
                oreMixer(
                ...
                oreMixer(
                    event,
                    1,
                    '#forge:ores/deposit/cadmium',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:potentium',
                        '2x kubejs:deposit_vincyte',
                        '2x kubejs:deposit_jimmium'
                    ],
                    32
                );
                oreMixer(
                    event,
                    1,
                    '#forge:ores/deposit/ostrum',
                    [
                        'kubejs:catalyst_basic',
                        '2x kubejs:deposit_kharaxium',
                        '2x kubejs:deposit_densite',
                        '2x kubejs:deposit_imortite'
                    ],
                    32
                );
                oreMixer(
                ...
                oreMixer(
                    event,
                    1,
                    '#forge:ores/deposit/orichalcum',
                    [
                        'kubejs:catalyst_magic',
                        '2x kubejs:deposit_imortite',
                        '2x kubejs:deposit_potentium',
                        '2x kubejs:deposit_kharaxium'
                    ],
                    32
                );
                ...
                oreMixer(
                    event,
                    1,
                    '#forge:ores/leached/iridium',
                    [
                        'kubejs:catalyst_basic',
                        '3x kubejs:leached_vincyte',
                        '3x kubejs:leached_densite',
                        '3x kubejs:leached_jimmium'
                    ],
                    64
                );
                oreMixer(
                    event,
                    1,
                    '#forge:ores/leached/calorite',
                    [
                        'kubejs:catalyst_basic',
                        '3x kubejs:leached_potentium',
                        '3x kubejs:leached_jimmium',
                        '3x kubejs:leached_imortite'
                    ],
                    64
                );
                oreMixer(
                    event,
                    1,
                    '#forge:ores/leached/adamantium',
                    [
                        'kubejs:catalyst_magic',
                        '3x kubejs:leached_imortite',
                        '3x kubejs:leached_kharaxium',
                        '3x kubejs:leached_potentium'
                    ],
                    64
                );
                ...
                oreMixer(
                    event,
                    1,
                    '#forge:ores/crystal/vibranium',
                    [
                        'kubejs:catalyst_basic',
                        '4x kubejs:crystal_imortite',
                        '4x kubejs:crystal_potentium',
                        '4x kubejs:crystal_kharaxium'
                    ],
                    128
                );
                oreMixer(
                    event,
                    1,
                    '#forge:ores/crystal/uru',
                    [
                        'kubejs:catalyst_basic',
                        '4x kubejs:crystal_jimmium',
                        '4x kubejs:crystal_vincyte',
                        '4x kubejs:crystal_densite'
                    ],
                    128
                );
                ...
                if (item.gem_components != null) {
                    if (Item.of(`#forge:gems/${item.gem_components[0]}`) != null) {
                        global.thermalCrystallizer(
                            event,
                            'water',
                            2000,
                            Item.of(`#forge:gems/${item.gem_components[0]}`).toResultJson(),
                            `#forge:dusts/${item.material}`,
                            `mbm2:crystallizer/${item.gem_components[0]}_from_${item.material}`
                        );
                    } else {
                        console.log(`${item.gem_components[0]} has no gem!`);
                    }
                    if (Item.of(`#forge:gems/${item.gem_components[1]}`) != null) {
                        global.pneumaticcraftThermoPlant(
                            event,
                            Item.of(`#forge:gems/${item.gem_components[1]}`),
                            Ingredient.of(`#forge:dusts/${item.material}`),
                            {
                            ...
                            1.0,
                            false,
                            `mbm2:thermo_plant/${item.gem_components[1]}_from_${item.material}`
                        );
                    } else {
        ...
        if (item.type == 'compound_rare_metal') {
            ...
            global.alchemistryDissolver(
                event,
                [
                    {
                        probability: 3.0,
                        results: [{ item: `chemlib:${item.components[0]}`, count: 4 }]
                    },
                    {
                        probability: 1.0,
                        results: [{ item: `chemlib:${item.components[1]}`, count: 4 }]
                    },
                    {
                        probability: 1.0,
                        results: [{ item: `chemlib:${item.components[2]}`, count: 4 }]
                    },
                    {
                        probability: 1.0,
                        results: [{ item: `chemlib:${item.components[3]}`, count: 4 }]
                    }
                ],
                `kubejs:${item.material}_blend_chunk`,
                1,
                4,
                true,
                `mbm2:dissolving/${item.material}_blend_chunk`
            );
            ...
            event.recipes.thermal
                .centrifuge(
                    [
                        ...
                        Item.of(`#forge:dusts/${item.components[1]}`).withChance(0.5),
                        Item.of(`#forge:dusts/${item.components[2]}`).withChance(0.25),
                        Fluid.of(`mekanism:${item.components[3]}`, 250)
                    ],
                    `kubejs:${item.material}_blend_chunk`
                )
                .id(`mbm2:centrifuge/${item.material}_blend_chunk`);
        }
    });
});
...
onEvent('lootjs', (event) => {
    event.enableLogging();
    event
        .addBlockLootModifier('#forge:ores/cheese')
    ...
    event
        .addBlockLootModifier('#forge:ores/runic')
        .removeLoot(Item.of('forbidden_arcanus:rune'))
        .pool((pool) => {
            pool.addLoot('forbidden_arcanus:rune');
            pool.applyOreBonus('minecraft:fortune');
        });
    event.addBlockLootModifier('#forge:ores/tin').removeLoot(Item.of('mekanism:raw_tin'));
    global.newMaterialParts.forEach((item) => {
        if (item.ore /*&& item.material != 'arcanite'*/) {
            console.log('adding ore drops for: ' + item.material);
            ////////////ORE DROPS//////////////////
            event
                .addBlockLootModifier(`#forge:ores/${item.material}`)
                ...
                .apply((ctx) => {
                    ...
                    if (!player) return;
                    if (
                        ItemFilter.hasEnchantment('minecraft:silk_touch').test(player.mainHandItem)
                    ) {
                        ctx.removeLoot(
                            Ingredient.getAll().filter(
                                Ingredient.of(`#forge:ores/${item.material}`).not()
                            )
                        );
                    } else {
            ...
            if (Item.of(`#forge:poor_ores/${item.material}`) != null) {
                event
                    .addBlockLootModifier(`#forge:poor_ores/${item.material}`)
                    .pool((pool) => {
                        if (item.type == 'dust') {
                            //(Poor) Dust
                            pool.addWeightedLoot(
                    ...
                    .apply((ctx) => {
                        ...
                        if (!player) return;
                        if (
                            ItemFilter.hasEnchantment('minecraft:silk_touch').test(
                                player.mainHandItem
                            )
                        ) {
                            ctx.removeLoot(
                                Ingredient.getAll().filter(
                                    Ingredient.of(`#forge:poor_ores/${item.material}`).not()
                                )
                            );
                        } else {
            ...
            if (item.type == 'gem') {
                event
                    .addBlockLootModifier(`kubejs:${item.material}_ore_sample`)
                    .replaceLoot(
                        `kubejs:${item.material}_ore_sample`,
                        `#forge:gems/${item.material}`
                    );
            } else if (item.type == 'dust') {
                event
                    .addBlockLootModifier(`kubejs:${item.material}_ore_sample`)
        ...
        if (item.type == 'element') {
            elementalMobDrops.forEach((element) => {
                if (element.element == item.material) {
                    ...
                    event.addBlockLootModifier(`#forge:ores/${item.material}`).pool((pool) => {
                        pool.addWeightedLoot(
                            [0, 1],
                            [
    ...
    event
        .addBlockLootModifier('#forge:ores/arcanite')
    ...
    global.newMaterialParts.forEach((item) => {
        ...
        if (item.type == 'base_metal') {
            refinableOre(5).forEach((part) => {
                ...
                event.addJson(
                    `forbidden_arcanus:hephaestus_forge/rituals/${item.material}/${part.split('/')[1]}`,
                    logvar
                );
                console.log(logvar);
            });
