		...
		////////////////////////////////////////////////////////////////
			...
			///////////////////////////////////////// TIER 2 SORTING ///////////////////////////////////////////
					...
					//Sorting F grade at tier 2
				  	event.recipes.multiblocked.multiblock('sorter_mk2')
				  	.inputItem(`12x #forge:ores/${global.oreProcessingParts[1].name}/${item.material}`)
				  	...
				  	.outputItem(`2x #forge:ores/${global.oreProcessingParts[1].name}/${item.components[2]}`)
				  	.outputItem('1x thermal:slag')
						.setPerTick(true)
					.inputFE(500)
				  	.duration(200)
				  ...
				  //Sorting E grade at tier 2
					event.recipes.multiblocked.multiblock('sorter_mk2')
					.inputItem(`16x #forge:ores/${global.oreProcessingParts[2].name}/${item.material}`)
					.outputItem(`6x #forge:ores/${global.oreProcessingParts[2].name}/${item.components[0]}`)
					.outputItem(`5x #forge:ores/${global.oreProcessingParts[2].name}/${item.components[1]}`)
					.outputItem(`3x #forge:ores/${global.oreProcessingParts[2].name}/${item.components[2]}`)
					.outputItem(`1x #forge:ores/${global.oreProcessingParts[2].name}/${item.components[3]}`)
					.outputItem('1x thermal:slag')
						.setPerTick(true)
					.inputFE(500*4)
					.duration(200)
					...
					//Sorting D grade at tier 2
					  event.recipes.multiblocked.multiblock('sorter_mk2')
					  .inputItem(`20x #forge:ores/${global.oreProcessingParts[3].name}/${item.material}`)
					  ...
					  .outputItem(`1x #forge:ores/${global.oreProcessingParts[3].name}/${item.components[4]}`)
					  .outputItem('1x thermal:slag')
						  .setPerTick(true)
					  .inputFE(500*4)
					  .duration(200)
				  ...
				  //Sorting C grade at tier 2
				  	event.recipes.multiblocked.multiblock('sorter_mk2')
				  	.inputItem(`24x #forge:ores/${global.oreProcessingParts[4].name}/${item.material}`)
				  	...
				  	.outputItem(`1x #forge:ores/${global.oreProcessingParts[4].name}/${item.components[5]}`)
				  	.outputItem('1x thermal:slag')
						.setPerTick(true)
					.inputFE(500*16)
				  	.duration(200)
					...
					event.recipes.multiblocked.multiblock('sorter_mk2')
					.inputItem(`28x #forge:ores/${global.oreProcessingParts[5].name}/${item.material}`)
					...
					.outputItem(`1x #forge:ores/${global.oreProcessingParts[5].name}/${item.components[6]}`)
					.outputItem('1x thermal:slag')
						.setPerTick(true)
					.inputFE(500*64)
					.duration(200)
					...
					event.recipes.multiblocked.multiblock('sorter_mk2')
					.inputItem(`32x #forge:ores/${global.oreProcessingParts[6].name}/${item.material}`)
					...
					.outputItem(`1x #forge:ores/${global.oreProcessingParts[6].name}/${item.components[7]}`)
					.outputItem('1x thermal:slag')
					  .setPerTick(true)
				  	.inputFE(500*256)
					.duration(200)
