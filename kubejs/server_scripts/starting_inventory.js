...
onEvent('player.logged_in', event => {
	...
	if (!event.player.stages.has('starting_items')) {
	  ...
	  event.player.give(bigTome)
	  event.player.give('allomancy:vial')
	}
  })

onEvent('recipes', event => {
  event.shaped(bigTome, [
	  ' G ',
	  'GBG',
	  ' G '
	], {
