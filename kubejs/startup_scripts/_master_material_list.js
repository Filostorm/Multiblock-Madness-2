global.newMaterialParts = [
...

    {
        ...
        byproducts: ['nickel'],
        allomancy:
            'Iron allows you to Pull on metals. For items and other small entities, this means pulling them toward you. For blocks and large metallic entities, this means you move toward them',
    ...
    },
    {
        ...
        byproducts: ['flourite'],
        allomancy:
            'Tin gives you Night Vision, and allows you to see which direction sounds come from using an indicator particle. This particle is also colored according to the hostility of the sound source. Friendly mobs are green, hostile mobs are red',
    ...
    },
    {
        ...
        byproducts: ['iron'],
        allomancy:
            'Gold lets you see into your "past" by showing you the location you most recently died in this dimension',
    ...
    },
    {
        ...
        allomancy:
            'Copper hides your Allomancy from detection. When you are burning copper, yourself and other allomancers nearby are cloaked from the senses of a Bronze burner. However, your own ability to use Bronze is nullified when burning Copper',
    ...
    },
    {
        ...
        type: 'base_metal',
        tier: 1,
        itemParts: ['plate', 'gear', 'rod', 'wire', 'fine_dust'],
        blockParts: [],
        fluid_id: 'tconstruct:molten_zinc',
        ore: true,
        byproducts: ['sulfur'],
        allomancy:
            'Zinc allows you to Riot the emotions of mobs, making them hostile. This means they will attack anything nearby. Even farm animals can be a threat',
    ...
    },
    {
        ...
        byproducts: ['titanium'],
        allomancy:
            'Aluminum is a purifying metal - it removes all metals from your current stock. This may seem useless, but it also removes all potion effects - not a bad trade to remove some Wither or Poison before it kills you',
        feruchemy:
...

    {
        ...
        blockParts: ['storage_block', 'coil', 'scaffolding'],
        ore: true,
        raw_ore: true,
        fluid: 'thick',
    ...
    },
    {
        ...
        itemParts: [
            ...
            'plating',
            'bolt',
            'fine_dust' /*, 'wire', 'model_spool', 'model_wire_coil', */
        ],
        blockParts: ['storage_block'],
        ore: true,
        raw_ore: true,
    ...
    },
    {
        ...
        fluid: 'thick',
        allomancy:
            'Chromium removes all metals from the stock of players you click on, while also removing all potion effects from them',
    ...
    /////////////// Tier 1 Alloys: Create Mixer /////////////////////////////
    {
        ...
        allomancy:
            'Bronze allows you to detect the Allomancy of other players, in much the same way Iron or Steel detects metal or Tin indicates sounds',
        feruchemy:
            'Wakefulness--Reset Phantom Timer/Switch Day to night or Night to Day or Spawn Phantoms within ~30 of storage (Must store the whole time)'
    },
    {
        material: 'electrum',
        color: 0xe6db95,
        ...
        allomancy:
            'Electrum lets you see your "future", showing you the location of your current spawn point',
    ...
    },
    {
        ...
        allomancy:
            'Brass allows you to Soothe the emotions of mobs, making them passive, even fearful. Creepers are your buddies!',
    ...
    },*/,
    {
        ...
        ingot_input: [
            '#forge:ingots/arcanite',
            ['naturesaura:gold_powder', 'naturesaura:gold_leaf']
        ]
    },
    //{
    //  'material': 'cast_iron',
    ...
    },
    {
        ...
        allomancy:
            'Steel allows you to Push on metals. This means moving metal items away from you, or pushing yourself off of metal blocks. This can be used as a sort of rudimentary flight, though it is more falling with style than anything else. Steel also allows you to use the Coin Bag item. If you have gold nuggets in your inventory and are burning steel, you can use this as a ranged weapon similar to the old Beta-edition Bow. Iron nuggets can also be used, causing more damage but far less accurately',
    ...
    },
    {
        ...
        tinkers_input: [
            { name: 'tconstruct:molten_iron', amount: 90 },
            { name: 'kubejs:molten_carbon', amount: 100 },
    ...
    },
    {
        ...
        base: true,
        dust_input: [
            '3x #forge:dusts/aluminum',
            '2x #forge:dusts/white_alloy',
            '8x create:experience_nugget'
        ],
        ingot_input: [
            '3x #forge:ingots/aluminum',
            '2x #forge:ingots/white_alloy',
            '8x create:experience_nugget'
        ],
    ...
    //},
    {
        ...
        base: true,
        dust_input: [
            '2x #forge:dusts/lumium',
            '3x #forge:dusts/titanium',
            '2x #forge:dusts/energetic_alloy',
            '4x hostilenetworks:nether_prediction'
        ],
        ingot_input: [
            '2x #forge:ingots/lumium',
            '3x #forge:ingots/titanium',
            '2x #forge:ingots/energetic_alloy',
            '4x hostilenetworks:nether_prediction'
        ],
...

    {
        ...
        itemParts: [
            ...
            'reinforced_plating',
            'hull_panel',
            /* 'base_ingot', 'base_dust',*/ 'fine_dust'
        ],
        blockParts: ['storage_block'],
    ...
    },
    {
        ...
        base: true,
        dust_input: [
            '2x #forge:dusts/signalum',
            '3x #forge:dusts/rune',
            '#forge:dusts/molybdenum',
            '4x hostilenetworks:end_prediction'
        ],
        ingot_input: [
            '2x #forge:ingots/signalum',
            '3x #forge:ingots/rune',
            '#forge:ingots/molybdenum',
            '4x hostilenetworks:end_prediction'
        ],
    ...
    /////////////// Tier 6 Alloys /////////////////////////////
    {
        ...
        blockParts: ['storage_block', 'hull_casing'],
    ...
    /////////////// Tier 7 Alloys /////////////////////////////
    {
        ...
        amount: 4,
        dust_input: [
            '3x #forge:dusts/lunar_alloy',
            '#forge:dusts/aerospace_alloy',
            '8x kubejs:asteroid_dust_tier_1',
            '16x chemlib:krypton'
        ],
        ingot_input: [
            '3x #forge:ingots/lunar_alloy',
            '#forge:ingots/aerospace_alloy',
            '8x kubejs:asteroid_dust_tier_1',
            '16x chemlib:krypton'
        ]
    },
    {
        ...
        blockParts: ['storage_block'],
        fluid_id: 'kubejs:molten_astral_fusion',
        fluid: 'thick',
        amount: 2,
        dust_input: [
            '3x #forge:dusts/space_alloy',
            '4x kubejs:asteroid_dust_tier_2',
            '16x chemlib:oganesson'
        ],
        ingot_input: [
            '3x #forge:ingots/space_alloy',
            '4x kubejs:asteroid_dust_tier_2',
            '16x chemlib:oganesson'
        ]
    },
    {
        material: 'elite_iridium_alloy',
        color: 0x3ec25b,
        type: 'alloy',
        iconset: 'mechanical',
        tier: 7,
    ...
    /////////////// Tier 8 Alloys /////////////////////////////
    {
        ...
        fluid: 'thick'
        //'amount': 12,
        //'dust_input': ['kubejs:einsteinium_dust','kubejs:astral_fusion_dust','kubejs:adamantine_alloy_dust','kubejs:exoskeleton_composit_dust','kubejs:extra_dimensional_alloy','kubejs:asteroid_dust_tier_3'],
        //'ingot_input': ['6x #forge:ingots/iridium','2x #forge:ingots/platinum','2x #forge:ingots/osmium','#forge:ingots/rhodium','#forge:ingots/ruthenium'],
    },
    /////////////// Ore /////////////////////////////
    /*
    {
