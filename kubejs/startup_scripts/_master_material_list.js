...
//////////////////////// Thermolytic /////////////////////////
...

    {
      ...
      'tier': 1,
      'iconset': 'mechanical',
      'itemParts': ['ingot', 'nugget', 'dust',   'plate', 'gear', 'interlocking_component', 'rod', 'model_robot_arm', 'wire', 'model_spool'],
      'blockParts': ['storage_block', 'cog_block',],
      'fluid_id': 'kubejs:molten_tier_1_mechanical_alloy',
      'fluid': 'thick',
      'amount': 3,
      'dust_input': ['4x #forge:dusts/iron','#forge:dusts/nickel','#forge:dusts/zinc','ars_nouveau:air_essence'],
      'ingot_input': ['4x #forge:ingots/iron','#forge:ingots/nickel', '#forge:ingots/zinc','ars_nouveau:air_essence'],
    },
    {
    ...
    },
    {
      ...
      'ingot_input': ['4x #forge:ingots/copper','#forge:ingots/silver', '#forge:ingots/zinc','ars_nouveau:water_essence'],
    },
    {
      ...
      'fluid': 'thick',
      'amount': 3,
      'dust_input': ['4x #forge:dusts/tin','#forge:dusts/nickel','#forge:dusts/lead','ars_nouveau:earth_essence'],
      'ingot_input': ['4x #forge:ingots/tin','#forge:ingots/nickel', '#forge:ingots/lead','ars_nouveau:earth_essence'],
    },
    {
    ...
    },
    {
      ...
      'fluid': 'thick',
      'amount': 2,
      'dust_input': ['3x #forge:dusts/tier_2_structural_alloy','2x #forge:dusts/tungsten','#forge:plastic'],
