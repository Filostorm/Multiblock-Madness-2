global.newMaterialParts = [
    ...
    /////////////// Tier 2 Metals /////////////////////////////
    {
      ...
      'type': 'base_metal',
      'tier': 2,
      'itemParts': ['plate', 'gear', 'rod', 'wire', 'interlocking_component', 'model_spool', 'model_wire_coil', 'reinforced_plating', 'sheet', 'hull_panel', 'model_robot_arm'],
    ...
    },
    {
      ...
      'fluid': 'thick',
      'amount': 4,
      'dust_input': ['4x #forge:dusts/titanium','#forge:dusts/fireite','#forge:dusts/vanadium','4x kubejs:pyrotheum_dust'],
      'ingot_input': ['4x #forge:ingots/titanium','#forge:ingots/fireite', '#forge:ingots/vanadium','4x kubejs:pyrotheum_dust'],
    },
...
//////////////////////// Thermolytic /////////////////////////
...

    {
      ...
      'fluid': 'thick',
      'amount': 3,
      'dust_input': ['4x #forge:dusts/tin','#forge:dusts/nickel','#forge:dusts/zinc','ars_nouveau:air_essence'],
      'ingot_input': ['4x #forge:ingots/tin','#forge:ingots/nickel', '#forge:ingots/zinc','ars_nouveau:air_essence'],
    },
    {
      ...
      'ingot_input': ['4x #forge:ingots/gold','#forge:ingots/silver', '#forge:ingots/lead','ars_nouveau:fire_essence'],
    },
    {
      ...
      'fluid': 'thick',
      'amount': 3,
      'dust_input': ['4x #forge:dusts/copper','#forge:dusts/silver','#forge:dusts/drenched_iron','ars_nouveau:water_essence'],
      'ingot_input': ['4x #forge:ingots/copper','#forge:ingots/silver', '#forge:ingots/drenched_iron','ars_nouveau:water_essence'],
    },
    {
      ...
      'tier': 1,
      'iconset': 'structural',
      'itemParts': ['ingot', 'nugget', 'dust', 'plate', 'rod', 'plating', 'reinforced_plating', 'hull_panel', 'bolt'],
      'blockParts': ['storage_block', 'casing', 'scaffolding', 'hull_casing', 'frame_box'],
      'fluid_id': 'kubejs:molten_tier_1_structural_alloy',
      'fluid': 'thick',
      'amount': 3,
      'dust_input': ['4x #forge:dusts/iron','#forge:dusts/nickel','#forge:dusts/lead','ars_nouveau:earth_essence'],
      'ingot_input': ['4x #forge:ingots/iron','#forge:ingots/nickel', '#forge:ingots/lead','ars_nouveau:earth_essence'],
    },
    {
    ...
    },
    {
      ...
      'fluid': 'thick',
      'amount': 2,
      'dust_input': ['3x #forge:dusts/tier_1_structural_alloy','2x #forge:dusts/titanium','#forge:dusts/steel'],
      'ingot_input': ['3x #forge:ingots/tier_1_structural_alloy','2x #forge:ingots/titanium', '#forge:ingots/steel'],
    },
    {
