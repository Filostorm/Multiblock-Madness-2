onEvent('fluid.registry', (event) => {
    ...
    event
        .create(`raw_data`)
        .stillTexture('kubejs:block/fluid/raw_data')
        .flowingTexture('kubejs:block/fluid/raw_data')
        .bucketColor(0x091209);
    event
        .create(`refined_data`)
        .stillTexture('kubejs:block/fluid/refined_data')
        .flowingTexture('kubejs:block/fluid/refined_data')
        .bucketColor(0x080b12);
...
const $InfuseTypeDeferredRegister = java(
    'mekanism.common.registration.impl.InfuseTypeDeferredRegister'
);
...
SLURRY['register(net.minecraftforge.eventbus.api.IEventBus)'](
    $EventBuses.getModEventBus('kubejs').get()
);
