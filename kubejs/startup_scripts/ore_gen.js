onEvent('worldgen.remove', event => {
	event.removeOres(ores => {
	  ores.blocks = [ 'minecraft:coal_ore', 'minecraft:iron_ore', 'minecraft:gold_ore', 'minecraft:nether_gold_ore', 'minecraft:copper_ore', 'minecraft:quartz_ore', 'minecraft:lapis_ore', 'minecraft:emerald_ore', 'minecraft:diamond_ore', 'minecraft:redstone_ore', 'mna:vinteum_ore']
	})
...
onEvent('worldgen.add', event => {
		...
		if (item.tier <= 1 && item.ore && item.type != 'gem') {
			event.addOre((ore) => {
				...
				global.stoneTypes.forEach((type) => {
					...
					console.log(`kubejs:poor_${type.material}_${item.material}_ore`)
				})
	...
	event.addOre((ore) => {
		...
		global.stoneTypes.forEach((type) => {
			if (type.material != 'deepslate') {
				ore.addTarget(`kubejs:${type.material}_redstone_ore`, `kubejs:${type.material}_fire_ore`)
			}
		})
	...
	event.addOre((ore) => {
		...
		global.stoneTypes.forEach((type) => {
			if (type.material != 'deepslate') {
				ore.addTarget(`kubejs:${type.material}_copper_ore`, `kubejs:${type.material}_water_ore`)
			}
		})
	...
	event.addOre((ore) => {
		...
		global.stoneTypes.forEach((type) => {
			if (type.material != 'deepslate') {
				ore.addTarget(`kubejs:${type.material}_gold_ore`, `kubejs:${type.material}_air_ore`)
			}
		})
		//Add to Tin
		...
		global.stoneTypes.forEach((type) => {
			if (type.material != 'deepslate') {
				ore.addTarget(`kubejs:${type.material}_tin_ore`, `kubejs:${type.material}_air_ore`)
			}
		})
	...
	event.addOre((ore) => {
		...
		global.stoneTypes.forEach((type) => {
			if (type.material != 'deepslate') {
				ore.addTarget(`kubejs:${type.material}_iron_ore`, `kubejs:${type.material}_earth_ore`)
			}
		})
		//Add to Zinc
		...
		global.stoneTypes.forEach((type) => {
			if (type.material != 'deepslate') {
				ore.addTarget(`kubejs:${type.material}_zinc_ore`, `kubejs:${type.material}_earth_ore`)
			}
		})
...
/*
	...
	event.addOre((ore) => {
		...
		global.newMaterialParts.forEach((item) => {
			global.stoneTypes.forEach((type) => {
				if (item.ore) {
					ore.addTarget(`excavated_variants:${type.material}_${item.material}_ore`, `excavated_variants:${type.material}_sulfur_ore`)
				}
			})
		})
	...
	event.addOre((ore) => {
		...
		global.newMaterialParts.forEach((item) => {
			global.stoneTypes.forEach((type) => {
				if (item.ore) {
					ore.addTarget(`excavated_variants:${type.material}_${item.material}_ore`, `kubejs:${type.material}_lumite_ore`)
				}
			})
		})
		ore.count(200)
