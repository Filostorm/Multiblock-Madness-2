...
onEvent('worldgen.add', (event) => {
    ...
    event.addOre((ore) => {
        ...
        ore.count([1, 6]).squared().uniformHeight(anchors.aboveBottom(25), anchors.absolute(100));
        ore.size = 25;
    ...
    event.addOre((ore) => {
        ...
        ore.count([1, 4]).squared().uniformHeight(anchors.aboveBottom(5), anchors.absolute(100));
        ore.size = 25;
        ore.noSurface = moonSurfaceChance;
        ore.worldgenLayer = 'underground_ores';
        ore.chance = 0;
    ...
    event.addOre((ore) => {
        ...
        global.stoneTypes.forEach((type) => {
            if (type.material != 'bedrock' && type.material != 'deepslate') {
                ore.addTarget(
                    `kubejs:${type.material}_platinum_ore`,
                    `kubejs:${type.material}_rune_ore`
                );
            }
        });
    ...
    event.addOre((ore) => {
        ...
        global.stoneTypes.forEach((type) => {
            if (Item.of(`excavated_variants:${type.material}_osmium_ore`) != null) {
                ore.addTarget(
                    `#forge:${type.material}`,
                    `excavated_variants:${type.material}_osmium_ore`
                );
            }
        });
    ...
    event.addOre((ore) => {
        ...
        ore.count([1, 2]).squared().uniformHeight(anchors.aboveBottom(25), anchors.absolute(100));
        ore.size = 20;
        ore.noSurface = 0;
        ore.worldgenLayer = 'underground_ores';
        ore.chance = 0;
    ...
    event.addOre((ore) => {
        ...
        ore.count([1, 4]).squared().uniformHeight(anchors.aboveBottom(0), anchors.absolute(75));
        ore.size = 20;
        ore.noSurface = 0;
        ore.worldgenLayer = 'underground_ores';
        ore.chance = 0;
    ...
    event.addOre((ore) => {
        ...
        ore.count(100).squared().uniformHeight(anchors.aboveBottom(0), anchors.absolute(75));
        ore.size = 10;
        ore.noSurface = 0;
        ore.worldgenLayer = 'underground_decoration';
        ore.chance = 0;
    ...
    event.addOre((ore) => {
        ...
        global.stoneTypes.forEach((type) => {
            if (Item.of(`excavated_variants:${type.material}_uranium_ore`) != null) {
                ore.addTarget(
                    `#forge:${type.material}`,
                    `excavated_variants:${type.material}_uranium_ore`
                );
            }
        });
        ore.count([1, 2]).squared().uniformHeight(anchors.aboveBottom(0), anchors.absolute(50));
        ore.size = 20;
        ore.noSurface = 0;
        ore.worldgenLayer = 'underground_ores';
        ore.chance = 0;
    ...
    event.addOre((ore) => {
        ...
        global.stoneTypes.forEach((type) => {
            if (Item.of(`kubejs:${type.material}_cadmium_ore`) != null) {
                ore.addTarget(
                    `excavated_variants:${type.material}_uranium_ore`,
                    `kubejs:${type.material}_cadmium_ore`
                );
            }
        });
        ore.count(100).squared().uniformHeight(anchors.aboveBottom(0), anchors.absolute(50));
        ore.size = 10;
        ore.noSurface = 0;
        ore.worldgenLayer = 'underground_decoration';
        ore.chance = 0;
