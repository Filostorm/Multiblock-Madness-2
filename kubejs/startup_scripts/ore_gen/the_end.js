...
onEvent('worldgen.add', (event) => {
    ...
    event.addOre((ore) => {
        ...
        ore.count([1, 2]).squared().uniformHeight(anchors.aboveBottom(15), anchors.absolute(65));
        ore.size = 25;
    ...
    event.addOre((ore) => {
        ...
        global.stoneTypes.forEach((type) => {
            if (type.material != 'bedrock' && type.material != 'deepslate') {
                ore.addTarget(
                    `kubejs:${type.material}_titanium_ore`,
                    `kubejs:${type.material}_aetherium_ore`
                );
            }
        });
        ore.count(200).squared().uniformHeight(anchors.aboveBottom(15), anchors.absolute(65));
        ore.size = 10;
        ore.noSurface = endSurfaceChance;
    ...
    event.addOre((ore) => {
        ...
        ore.count([1, 4]).squared().uniformHeight(anchors.aboveBottom(15), anchors.absolute(65));
        ore.size = 20;
        ore.noSurface = endSurfaceChance;
        ore.worldgenLayer = 'underground_ores';
        ore.chance = 0;
